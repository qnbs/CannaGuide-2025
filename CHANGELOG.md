...
## [1.5.0](https://github.com/qnbs/CannaGuide-2025/compare/cannaguide-2025-v1.4.1...cannaguide-2025-v1.5.0) (2026-04-09)
...
* **ai:** add fallback telemetry and zod response validation ([d686c14](https://github.com/qnbs/CannaGuide-2025/commit/d686c1414dc4c3045b09d6231225effba99af500))
...
* **ai:** add real token cost tracking for byok providers ([57daebf](https://github.com/qnbs/CannaGuide-2025/commit/57daebf0c64784666b48b491ec664b0765879335))
...
* **audit:** close 6 medium-priority audit items (s76) ([244a1ae](https://github.com/qnbs/CannaGuide-2025/commit/244a1aeeba88e0738e5d4fc24fccabc70291a346))
...
* **ci:** add netlify preview validation and rtl infra ([7d2c3cf](https://github.com/qnbs/CannaGuide-2025/commit/7d2c3cfc6a0981897bf434b3fb8ba1e9f23ef77f))
...
* **ci:** audit p0 sprint + sonarcloud removal ([389f9f3](https://github.com/qnbs/CannaGuide-2025/commit/389f9f3969b0ca0d8af313dac420991b6a0df58a))
...
* **ci:** release-gate workflow + audit-backlog check + telemetry panel + indexeddb prune ([d7933a9](https://github.com/qnbs/CannaGuide-2025/commit/d7933a96cd5b383617075b12997b4eff259c9c67))
* **crdt:** differential encoding + bridge batching + workerbus telemetry ([510d3b0](https://github.com/qnbs/CannaGuide-2025/commit/510d3b041e9d2e77d3314a1bf08853cc436f09a5))
...
* **grows:** add grow switcher navigation and grow management ui ([fe623d6](https://github.com/qnbs/CannaGuide-2025/commit/fe623d6c87cd46191fcd46d9786b88ade456ff5b))
* **grows:** add multi-grow state layer with migration and grow-scoped selectors ([860bf1a](https://github.com/qnbs/CannaGuide-2025/commit/860bf1a39ee0e2dffe9f38fc796ceb693b114cf6))
* **grows:** multi-grow ai integration, data export, stats (D/D) ([e0bc74a](https://github.com/qnbs/CannaGuide-2025/commit/e0bc74a0b75ad131a7d5c5fa20ae212b30a0050e))
...
* **i18n:** 100% coverage hydro equipment calculator strain-comparison session 78 ([129a240](https://github.com/qnbs/CannaGuide-2025/commit/129a240af3c8d1629bf5cbfc1b400f9cf6fea119))
...
* **sync:** add yjs crdt foundation with redux bridge adapters ([9aa7c2b](https://github.com/qnbs/CannaGuide-2025/commit/9aa7c2bc10d5fa72a0212ebc411a4849f6e4c4da))
* **sync:** crdt production hardening -- error boundaries, loop detector, lww fallback (iii/iii) ([179246b](https://github.com/qnbs/CannaGuide-2025/commit/179246b162f06b95a7f0bb384315be561d5746be))
* **sync:** crdt-aware gist sync with conflict resolution ui ([1bd22ca](https://github.com/qnbs/CannaGuide-2025/commit/1bd22ca2b7a585e63c9d2444fa3635cc9a3077ba))
...
* **voice:** v-05 extended commands + levenshtein fuzzy + ittpsprovider ([d7ecfdc](https://github.com/qnbs/CannaGuide-2025/commit/d7ecfdc864d3887f07ea35ed32e29d0cfc4a1ac7))
...
* **workerbus:** w-01 rate-limit + w-03 telemetry export, readme feature audit ([4283ec7](https://github.com/qnbs/CannaGuide-2025/commit/4283ec765b29cb999f5443bc555f6f1e2adcf872))
* **workerbus:** w-02 priority preemption with abort + re-queue ([9055d0e](https://github.com/qnbs/CannaGuide-2025/commit/9055d0e074ca9b5599a0c0a136ec769d7bef8c3a))
* **workerbus:** w-04 cross-worker channels + generic typed dispatch ([a24ae3b](https://github.com/qnbs/CannaGuide-2025/commit/a24ae3b3874293d2db9eeb9f1070dc37da644eb1))
...
* **ci:** dashboardSummary.test useSelector mock needs RootState not unknown ([98855c9](https://github.com/qnbs/CannaGuide-2025/commit/98855c9510d001b038a0a2aad7d91a3f1abae827))
* **ci:** deploy pipeline -- fix locator, lhci binary, badge decoupling ([216b605](https://github.com/qnbs/CannaGuide-2025/commit/216b605931c2582ebd4a78438d202ac3e0836d26))
...
* **ci:** fix docker deployment and remove false-safety continue-on-error ([3751133](https://github.com/qnbs/CannaGuide-2025/commit/3751133bbb74dff2f799f21fe7a7ee324089f4de))
...
* **ci:** repair dependabot auto-merge + add deployment cleanup ([a6b20d2](https://github.com/qnbs/CannaGuide-2025/commit/a6b20d27808631c549a87c887f72d9d9db71c683))
...
* **ci:** resolve deploy, docker, tauri failures + docs audit ([75d0220](https://github.com/qnbs/CannaGuide-2025/commit/75d022059d57da9f7f479d88f2e3f374aee6372b))
* **ci:** resolve e2e boot hang from circular chunk imports ([eb6a67f](https://github.com/qnbs/CannaGuide-2025/commit/eb6a67f8b3de0b3e805ca859a58a936d0ed4c651))
* **ci:** resolve e2e boot race condition and artifact name slash ([0ac1df6](https://github.com/qnbs/CannaGuide-2025/commit/0ac1df6bc667a0429152deb22a056ddf6f97e413))
...
* **ci:** resolve exactOptionalPropertyTypes in store configureStore call ([ae0b1a3](https://github.com/qnbs/CannaGuide-2025/commit/ae0b1a33de7d6000ad2c3e1965e49317e1ccc7db))
* **ci:** resolve HelpView TS2322 + harden pre-push gate ([608aa9d](https://github.com/qnbs/CannaGuide-2025/commit/608aa9d21ab62546264163134baaefd2dc00abe1))
* **ci:** resolve pnpm audit failure and harden supply chain ([2a16126](https://github.com/qnbs/CannaGuide-2025/commit/2a16126a0c584b8158a5cbf857dbb20ce4453cfc))
...
* **ci:** resolve typecheck errors and eslint warnings in grows+sync ([0e057c1](https://github.com/qnbs/CannaGuide-2025/commit/0e057c15df2fdf74509216668b1f2af71c00dcf0))
* **ci:** restore continue-on-error on deploy post-checks, fix lighthouse dist path ([eaced88](https://github.com/qnbs/CannaGuide-2025/commit/eaced88b6aa1e7ecb3044e211f9c81cec90661fe))
* **ci:** rewrite pwa-update deploy test for reliability ([4ef3a45](https://github.com/qnbs/CannaGuide-2025/commit/4ef3a457d309246491bc9f8b824cc689b190ad6a))
...
* **ci:** type GrowCreateModal color state as string ([baecec6](https://github.com/qnbs/CannaGuide-2025/commit/baecec6046946934c63017294cd5321fcc4a4d4d))
* **ci:** unblock deploy by fixing pwa-update test timeout ([2e381a1](https://github.com/qnbs/CannaGuide-2025/commit/2e381a15d702b1be30d09a34cd371c2cea5099a3))
...
* **e2e:** add data-view-id to header nav, boot-ready gate, node24 actions ([0f40d61](https://github.com/qnbs/CannaGuide-2025/commit/0f40d613223032ab5119a86460e3b3afc87314aa))
* **e2e:** align settings sub-nav data-tab-id with app convention ([9817550](https://github.com/qnbs/CannaGuide-2025/commit/98175506e89287013a4bc7138ab52dd14e7b64e9))
* **e2e:** resolve webllm offline cache section locator (definitive) ([7aaedbc](https://github.com/qnbs/CannaGuide-2025/commit/7aaedbca39043c43fc24bbe4e4cfc9aff75c82db))
...
* **i18n:** correct namespace and key prefixes for leaked translation keys ([7cfee72](https://github.com/qnbs/CannaGuide-2025/commit/7cfee726edb6a2fea70639a09d1317870dc5a092))
...
* **i18n:** llm model selector keys and layout overflow ([c715ab4](https://github.com/qnbs/CannaGuide-2025/commit/c715ab431a986416f1d5511c8233f1f13b0e23ee))
* **i18n:** move comparison keys to strainsView, unify subnav cards ([a116250](https://github.com/qnbs/CannaGuide-2025/commit/a116250a51f7fd6219c6cde2e0fd809cbb896050))
...
* **security,ui,i18n,ci:** multi-fix session 97 ([0e9d9fc](https://github.com/qnbs/CannaGuide-2025/commit/0e9d9fce8f622d361f48a0600c4267f77416cb30))
...
* **security:** resolve all npm audit vulnerabilities + i18n namespace fix ([a12d138](https://github.com/qnbs/CannaGuide-2025/commit/a12d13820591d78802272e02bc65a96ff3a0a0d9))
...
* **strains:** remove 2 fuzzy-duplicate strains (778 -&gt; 776) ([713c896](https://github.com/qnbs/CannaGuide-2025/commit/713c896d4fa01fb018c239907efb57cdb93c6ebe))
...
* **ui:** re-enable no-explicit-any for tests + lint phase 4 stores ([3773ed0](https://github.com/qnbs/CannaGuide-2025/commit/3773ed054cb931b7dfee553dcec39d533090d8fd))
* **ui:** remove unused eslint-disable directives and redundant type annotations ([c5af594](https://github.com/qnbs/CannaGuide-2025/commit/c5af594d44a59d9486e6a161476c2a76e631bb79))
...
* **ui:** type hydro threshold fields as keyof HydroThresholds ([b938898](https://github.com/qnbs/CannaGuide-2025/commit/b93889880db3d8d12fc22c078eb496b711d537db))
...
* **workerbus:** remove stray preempted arg in dispatchWithRetry ([b99fe18](https://github.com/qnbs/CannaGuide-2025/commit/b99fe1802125bca4f1e1e0cc45cc5a7f5f4189fa))
* **workerbus:** spread telemetry export for sentry context compat ([838db67](https://github.com/qnbs/CannaGuide-2025/commit/838db67826d23b15ec936225912a07b5579120ff))
