...
[![Release](https://img.shields.io/badge/release-v1.8.2-brightgreen)](https://github.com/qnbs/CannaGuide-2025/releases)
...
[![Tests](https://img.shields.io/badge/tests-2794%20passed-brightgreen)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/ci.yml)
...
- [PWA & Offline Infrastructure](#pwa--offline-infrastructure)
- [State Management & Data Persistence](#state-management--data-persistence)
- [Plant Simulation Engine](#plant-simulation-engine)
- [AI System](#ai-system)
- [Detailed Plant View & Tabs](#detailed-plant-view--tabs)
- [Strain Library & Genetics](#strain-library--genetics)
- [Equipment & Calculators](#equipment--calculators)
- [Knowledge Base & AI Mentor](#knowledge-base--ai-mentor)
- [Settings & Configuration](#settings--configuration)
- [CI/CD, Testing & Security](#cicd-testing--security)
...
776 strains · 2794 tests · 130 services · 19 Redux slices + 9 Zustand stores · 28 hooks · 12 i18n namespaces · 9 themes · 24 CI workflows
...
| **Testing**     | Vitest + Playwright                  | 2794 unit/E2E/component tests               |
...
pnpm run test:run           # 2794 tests (263 files), single run
...
> Details: [Monorepo Architecture](docs/monorepo-architecture.md) · [Architecture Migration Plan](docs/ARCHITECTURE-MIGRATION-PLAN.md)
...
> API docs: [AI Facade](docs/api/ai-facade.md) · [RAG Pipeline](docs/api/rag-pipeline.md) · [Local AI Infrastructure](docs/api/local-ai-infrastructure.md)
...
### Testing (2794 tests, 0 failures)

| Type                  | Framework       | Scope                                           |
| --------------------- | --------------- | ----------------------------------------------- |
| **Unit/Integration**  | Vitest          | 2794 tests, colocated `*.test.ts(x)`            |
...
| ------------------ | ----------------------------- | -------------------------------------------------------------------------------- |
| CI                 | push, PR                      | Lint, typecheck, 2794 tests, build, security, E2E, IoT                           |
...
[![CodeQL](https://github.com/qnbs/CannaGuide-2025/actions/workflows/codeql.yml/badge.svg)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/codeql.yml)
[![Deploy](https://github.com/qnbs/CannaGuide-2025/actions/workflows/deploy.yml/badge.svg)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/deploy.yml)
[![Tests](https://img.shields.io/badge/Tests-2794%20bestanden-brightgreen)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/ci.yml)
...
[![GitHub Forks](https://img.shields.io/github/forks/qnbs/CannaGuide-2025?style=flat&logo=github)](https://github.com/qnbs/CannaGuide-2025/network/members)
[![GitHub Issues](https://img.shields.io/github/issues/qnbs/CannaGuide-2025?logo=github)](https://github.com/qnbs/CannaGuide-2025/issues)
[![GitHub PRs](https://img.shields.io/github/issues-pr/qnbs/CannaGuide-2025?logo=github)](https://github.com/qnbs/CannaGuide-2025/pulls)
[![Letzter Commit](https://img.shields.io/github/last-commit/qnbs/CannaGuide-2025?logo=github)](https://github.com/qnbs/CannaGuide-2025/commits/main)
[![Commit-Aktivitaet](https://img.shields.io/github/commit-activity/m/qnbs/CannaGuide-2025?logo=github)](https://github.com/qnbs/CannaGuide-2025/graphs/commit-activity)
[![Mitwirkende](https://img.shields.io/github/contributors/qnbs/CannaGuide-2025?logo=github)](https://github.com/qnbs/CannaGuide-2025/graphs/contributors)
[![Repo-Groesse](https://img.shields.io/github/repo-size/qnbs/CannaGuide-2025?logo=github)](https://github.com/qnbs/CannaGuide-2025)
...
[![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-FE5196?logo=conventionalcommits&logoColor=white)](https://conventionalcommits.org)
[![ESLint](https://img.shields.io/badge/ESLint-Flat%20Config-4B32C3?logo=eslint&logoColor=white)](https://eslint.org/)
[![Prettier](https://img.shields.io/badge/Prettier-formatiert-F7B93E?logo=prettier&logoColor=black)](https://prettier.io/)
[![TypeScript Strict](https://img.shields.io/badge/TS-Strict%20Mode-3178C6?logo=typescript&logoColor=white)](https://www.typescriptlang.org/tsconfig#strict)
[![Sicherheitsrichtlinie](https://img.shields.io/badge/Sicherheit-Richtlinie%20aktiv-green?logo=shield)](https://github.com/qnbs/CannaGuide-2025/security/policy)
[![Null Any](https://img.shields.io/badge/any-Null%20Toleranz-red?logo=typescript&logoColor=white)](https://github.com/qnbs/CannaGuide-2025)

<!-- KI-Entwicklungs-Stack -->

[![Prototyp in AI Studio](https://img.shields.io/badge/Prototyp%20in-Google%20AI%20Studio-4285F4)](https://aistudio.google.com)
[![Evaluiert von Grok](https://img.shields.io/badge/Evaluiert%20von-Grok4.20-000000)](https://x.ai)
...
776 Sorten · 2794 Tests · 130 Services · 19 Redux Slices + 9 Zustand Stores · 28 Hooks · 12 i18n-Namensraeume · 9 Themes · 24 CI-Workflows
...
| **Testing**    | Vitest + Playwright                  | 2794 Unit-/E2E-/Komponenten-Tests             |
...
pnpm run test:run           # 2794 Tests (263 Dateien), Einzellauf
...
> API-Doku: [AI Facade](docs/api/ai-facade.md) · [RAG Pipeline](docs/api/rag-pipeline.md) · [Local AI](docs/api/local-ai-infrastructure.md)
...
| Bereich          | Details                                                                                                                        |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **Tests**        | 2794 (Vitest + Playwright E2E + Komponenten + Stryker Mutation + Visual Regression + Fuzzing)                                  |
...
Beitraege willkommen! Siehe [CONTRIBUTING.md](CONTRIBUTING.md). API-Referenz: [docs/api/](docs/api/).
