...
[![Tests](https://img.shields.io/badge/tests-2253%20passed-brightgreen)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/ci.yml)
...
776 strains · 2253 tests · 117 services · 19 Redux slices + 9 Zustand stores · 26 hooks · 12 i18n namespaces · 9 themes · 22 CI workflows
...
| **Testing**     | Vitest + Playwright                  | 2253 unit/E2E/component tests               |
...
pnpm run test:run           # 2253 tests, single run
...
### Testing (2253 tests, 0 failures)

| Type                  | Framework       | Scope                                           |
| --------------------- | --------------- | ----------------------------------------------- |
| **Unit/Integration**  | Vitest          | 2253 tests, colocated `*.test.ts(x)`            |
...
| ------------------ | ---------------- | ---------------------------------------------------------- |
| CI                 | push, PR         | Lint, typecheck, 2253 tests, build, security, E2E, IoT     |
...
[![CodeQL](https://github.com/qnbs/CannaGuide-2025/actions/workflows/codeql.yml/badge.svg)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/codeql.yml)
[![Deploy](https://github.com/qnbs/CannaGuide-2025/actions/workflows/deploy.yml/badge.svg)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/deploy.yml)
[![Tests](https://img.shields.io/badge/Tests-2253%20bestanden-brightgreen)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/ci.yml)
...
776 Sorten · 2253 Tests · 117 Services · 19 Redux Slices + 9 Zustand Stores · 26 Hooks · 12 i18n-Namensraeume · 9 Themes · 22 CI-Workflows
...
| **Testing**    | Vitest + Playwright                  | 2253 Unit-/E2E-/Komponenten-Tests             |
...
pnpm run test:run           # 2253 Tests, Einzellauf
...
| Bereich          | Details                                                                                                 |
| ---------------- | ------------------------------------------------------------------------------------------------------- |
| **Tests**        | 2253 (Vitest + Playwright E2E + Komponenten + Stryker Mutation + Visual Regression + Fuzzing)           |
