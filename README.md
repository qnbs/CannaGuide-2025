...
*   **Riesige Bibliothek**: Zugriff auf detaillierte Informationen zu **über 450 Cannabissorten**.
...
*   **Professioneller Export & Management**: Exportieren Sie Sortendaten als **PDF**, **CSV**, **TXT** oder **JSON** und verwalten Sie alle Exporte im "Exporte"-Tab, ebenfalls mit voller **CRUD**-Unterstützung.
...
*   **Zustandsverwaltung:** Zustand (Zustand) für eine minimalistische, leistungsstarke und skalierbare globale Zustandsverwaltung.
...
CannaGuide 2025 is your definitive AI-powered digital co-pilot for the entire cannabis cultivation lifecycle. Engineered for both novice enthusiasts and master growers, this state-of-the-art **Progressive Web App (PWA)** guides you from seed selection to a perfectly cured harvest. Simulate grows, explore a vast strain library, plan equipment with Gemini-powered intelligence, and master your craft with an interactive, data-driven guide.
...
*   **Vast Library**: Access detailed information on **over 450 cannabis strains**.
...
*   **Professional Exporting & Management**: Export strain data as **PDF**, **CSV**, **TXT**, or **JSON** and manage all past exports in the "Exports" tab, also with full **CRUD** support.
...
*   **State Management:** Zustand for a minimalistic, powerful, and scalable global state management solution.
