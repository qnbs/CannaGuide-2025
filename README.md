...
[![Tests](https://img.shields.io/badge/tests-2140%20passed-brightgreen)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/ci.yml)
...
pnpm run test:run           # 2140 tests, single run
