...
[![Tests](https://img.shields.io/badge/tests-1729%20passed-brightgreen)](https://github.com/qnbs/CannaGuide-2025/actions/workflows/ci.yml)
...
| **Testing**        | Vitest 4.1, Playwright 1.58          | 1663 unit, E2E, component tests                            |
...
| Job                | Description                                                                 |
| ------------------ | --------------------------------------------------------------------------- |
| Quality Gates      | Lint, typecheck (root + workspaces via Turbo), 1663 tests, production build |
...
| **v1.4** | ✅ Released | Vision AI Leaf Diagnosis (ONNX), Hydro Forecast, WebLLM Model Catalog, Nutrient Deficiency Wizard, 5-Layer Prompt Injection Defense, WorkerBus Priority Queue, 1663 tests                                              |
...
| **3. Core Development**          | GitHub Codespaces + VS Code Copilot (Claude Opus 4.6) | Primary iteration engine -- feature refinement, security hardening, 1663 tests, CI/CD pipeline, local AI stack, documentation | v1.0 -> v1.4 |
...
| **Testing**        | Vitest 4.1, Playwright 1.58          | 1663 Unit-, E2E-, Komponenten-Tests           |
...
| Job                | Beschreibung                                                                 |
| ------------------ | ---------------------------------------------------------------------------- |
| Quality Gates      | Lint, Typecheck (Root + Workspaces via Turbo), 1663 Tests, Produktions-Build |
| 🛡 Security        | npm audit (critical), Trojan-Source-Scan, Gitleaks-Secret-Scan               |
...
| **v1.4** | ✅ Veröffentlicht | Vision AI Leaf Diagnosis (ONNX), Hydro Forecast, WebLLM Model Catalog, Nutrient Deficiency Wizard, 5-Layer Prompt Injection Defense, WorkerBus Priority Queue, 1663 Tests                                                                         |
...
| **3. Kernentwicklung**           | GitHub Codespaces + VS Code Copilot (Claude Opus 4.6) | Primaere Iterations-Engine -- Feature-Verfeinerung, Security-Hardening, 1663 Tests, CI/CD-Pipeline, lokaler KI-Stack, Dokumentation | v1.0 -> v1.4   |
