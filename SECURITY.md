...
| `linkify-it`  | 5.0.1           | [GHSA-22p9-wv53-3rq4](https://github.com/advisories/GHSA-22p9-wv53-3rq4) (high, ReDoS)                                                                        | `typedoc` → `markdown-it` → `linkify-it`                                                                    | Dev-only TypeDoc markdown plugin chain. Lockfile resolves to **5.0.1**.                                                                        |
| `markdown-it` | 14.2.0          | [GHSA-6v5v-wf23-fmfq](https://github.com/advisories/GHSA-6v5v-wf23-fmfq) (moderate, DoS)                                                                      | `typedoc` → `markdown-it`                                                                                   | Dev-only TypeDoc. Lockfile resolves to **14.2.0**.                                                                                             |
| `js-yaml`     | 3.15.0 / 4.2.0  | [GHSA-h67p-54hq-rp68](https://github.com/advisories/GHSA-h67p-54hq-rp68) (moderate, DoS)                                                                      | `@lhci/cli` → `@lhci/utils` (v3); `eslint` → `@eslint/eslintrc` (v4)                                        | Scoped overrides `js-yaml@3` and `js-yaml@4`. Lockfile resolves to **3.15.0** / **4.2.0**.                                                     |
