...
const CATEGORIES: Array<{
    ...
    { id: 'dynamicLighting', iconKey: 'dynamicLighting', color: 'text-primary-400' },
    { id: 'sensorsIoT', iconKey: 'sensorsIoT', color: 'text-accent-400' },
    { id: 'aiAutomation', iconKey: 'aiAutomation', color: 'text-secondary-400' },
    { id: 'digitalTwin', iconKey: 'digitalTwin', color: 'text-primary-400' },
    { id: 'hydroAero', iconKey: 'hydroAero', color: 'text-accent-400' },
    { id: 'tissueCulture', iconKey: 'tissueCulture', color: 'text-secondary-400' },
    { id: 'smartGrowBoxes', iconKey: 'smartGrowBoxes', color: 'text-primary-400' },
    { id: 'sustainability', iconKey: 'sustainability', color: 'text-accent-400' },
]
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div>
                <button
                    ...
                    disabled={aiLoading}
                    className="flex items-center gap-2 text-sm px-4 py-2 rounded-lg bg-accent-900/40 border border-accent-700/40 text-accent-300 hover:bg-accent-900/60 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                ...
                {aiResult !== null && (
                    <div className="mt-2 p-3 rounded-lg bg-accent-950/30 border border-accent-800/30 text-sm text-accent-200 leading-relaxed">
                                    ...
                                    {getRelatedGeneticForGrowTech(cat.id).length > 0 && (
                                        <div className="flex flex-wrap gap-1.5">
                                            {getRelatedGeneticForGrowTech(cat.id).map((genetic) => (
                                                <span
                                                    key={genetic}
                                                    className="text-xs px-2 py-0.5 rounded-full bg-accent-900/40 border border-accent-700/40 text-accent-300"
                                                >
                                                    {t(
            ...
            <div className="bg-gradient-to-r from-primary-600/10 to-accent-600/10 border border-primary-500/20 rounded-lg p-4">
