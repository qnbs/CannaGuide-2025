...
export const LightCalculator: React.FC = memo(() => {
    ...
    return (
        <CalculatorSection
            title={t('equipmentView.calculators.light.title')}
            description={t('equipmentView.calculators.light.description')}
        >
            <div className="grid grid-cols-2 gap-4">
                <Input
                    label={t('equipmentView.calculators.light.width')}
                    type="number"
                    unit="cm"
                ...
                />
                <Input
                    label={t('equipmentView.calculators.light.depth')}
                    type="number"
                    unit="cm"
            ...
            />
            <ResultDisplay
                label={t('equipmentView.calculators.light.result')}
