        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
                <label className="flex flex-col gap-1">
                    ...
                    />
                    <span className="text-3xs text-muted text-center">umol/m2/s</span>
                </label>
                <label className="flex flex-col gap-1">
                    <span className="text-xs text-slate-400">
                    ...
                    <input
                        ...
                        className="w-full rounded bg-slate-700 border border-slate-600 text-slate-100 text-center py-1.5 text-sm focus:ring-2 focus:ring-primary-500 focus:outline-none"
                    />
                    <span className="text-3xs text-muted text-center">h/day</span>
                </label>
                <label className="flex flex-col gap-1">
                    <span className="text-xs text-slate-400">
                    ...
                    <input
                        ...
                        className="w-full rounded bg-slate-700 border border-slate-600 text-slate-100 text-center py-1.5 text-sm focus:ring-2 focus:ring-primary-500 focus:outline-none"
                    />
                    <span className="text-3xs text-muted text-center">% (600-700 nm)</span>
                </label>
                <label className="flex flex-col gap-1">
                    <span className="text-xs text-slate-400">
                    ...
                    <input
                        ...
                        className="w-full rounded bg-slate-700 border border-slate-600 text-slate-100 text-center py-1.5 text-sm focus:ring-2 focus:ring-primary-500 focus:outline-none"
                    />
                    <span className="text-3xs text-muted text-center">% (400-500 nm)</span>
                </label>
            </div>
