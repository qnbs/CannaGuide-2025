        ...
        <div className="space-y-4" data-testid="leaf-diagnosis-panel">
            ...
            <div
                className={cn(
                    ...
                    modelStatus === 'not-cached' && 'bg-amber-900/30 border border-amber-800',
                    modelStatus === 'downloading' && 'bg-blue-900/30 border border-blue-800',
            ...
            >
                ...
                {modelStatus === 'not-cached' && (
                    <>
                        ...
                        <span className="text-amber-300 flex-1" data-testid="model-not-loaded">
                ...
                {modelStatus === 'error' && (
                    <>
                        ...
                        <Button size="sm" variant="danger" onClick={() => void handleDownload()}>
                            {t('diagnosis.download')}
                        </Button>
                    </>
                )}
            ...
            {result !== null && (
                ...
                >
                    ...
                    {result.recommendations.length > 0 ? (
                        <div>
                            ...
                            <ul className="space-y-1">
                                {result.recommendations.map((rec) => (
                                    <li key={rec.diseaseId} className="text-xs text-slate-400">
                        ...
                        <p className="text-xs text-slate-500">{t('diagnosis.noRecommendations')}</p>
                    )}
                </Card>
            )}
        </div>
