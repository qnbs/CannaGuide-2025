...
export const faqData: FAQItem[] = [
    ...
    },
    {
        ...
        triggers: {
            plantStage: [PlantStage.Seedling, PlantStage.Vegetative, PlantStage.Flowering],
        },
    },
    {
    ...
    {
        id: 'faq-dynamic-lighting',
        questionKey: 'faq.dynamicLighting.question',
        answerKey: 'faq.dynamicLighting.answer',
        triggers: {},
    },
    {
        id: 'faq-aeroponics-basics',
        questionKey: 'faq.aeroponicsBasics.question',
        answerKey: 'faq.aeroponicsBasics.answer',
        triggers: {},
    },
    {
        id: 'faq-digital-twin',
        questionKey: 'faq.digitalTwin.question',
        answerKey: 'faq.digitalTwin.answer',
        triggers: {},
    },
    {
        id: 'faq-tissue-culture',
        questionKey: 'faq.tissueCulture.question',
        answerKey: 'faq.tissueCulture.answer',
        triggers: {},
    },
    {
        id: 'faq-smart-grow-box',
        questionKey: 'faq.smartGrowBox.question',
        answerKey: 'faq.smartGrowBox.answer',
        triggers: {},
    },
    {
        id: 'faq-co2-enrichment',
        questionKey: 'faq.co2Enrichment.question',
        answerKey: 'faq.co2Enrichment.answer',
        triggers: { plantStage: [PlantStage.Vegetative, PlantStage.Flowering] },
    },
    {
        id: 'faq-smart-fertigation',
        questionKey: 'faq.smartFertigation.question',
