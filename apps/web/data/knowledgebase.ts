...
export const knowledgeBase: KnowledgeArticle[] = [
    ...
    {
        id: 'genetics-terpene-diversity',
        titleKey: 'strainsView.geneticTrends.categories.terpeneDiversity.title',
        contentKey: 'strainsView.geneticTrends.categories.terpeneDiversity.content',
        tags: ['genetics', 'terpenes', 'aroma', 'breeding', '2026'],
        triggers: {},
    },
    {
        id: 'genetics-ultra-potency',
        titleKey: 'strainsView.geneticTrends.categories.ultraPotency.title',
        contentKey: 'strainsView.geneticTrends.categories.ultraPotency.content',
        tags: ['genetics', 'thc', 'potency', 'cannabinoids', '2026'],
        triggers: {},
    },
    {
        id: 'genetics-balanced-hybrids',
        titleKey: 'strainsView.geneticTrends.categories.balancedHybrids.title',
        contentKey: 'strainsView.geneticTrends.categories.balancedHybrids.content',
        tags: ['genetics', 'hybrids', 'balanced', 'functional', '2026'],
        triggers: {},
    },
    {
        id: 'genetics-autoflowering',
        titleKey: 'strainsView.geneticTrends.categories.autofloweringRevolution.title',
        contentKey: 'strainsView.geneticTrends.categories.autofloweringRevolution.content',
        tags: ['genetics', 'autoflower', 'ruderalis', 'fast', '2026'],
        triggers: {},
    },
    {
        id: 'genetics-polyploidy',
        titleKey: 'strainsView.geneticTrends.categories.advancedBreeding.title',
        contentKey: 'strainsView.geneticTrends.categories.advancedBreeding.content',
        tags: ['genetics', 'polyploidy', 'triploid', 'breeding', 'advanced', '2026'],
        triggers: {},
    },
    {
        id: 'genetics-landrace-revival',
        titleKey: 'strainsView.geneticTrends.categories.landraceRevival.title',
        contentKey: 'strainsView.geneticTrends.categories.landraceRevival.content',
        tags: ['genetics', 'landrace', 'heritage', 'preservation', '2026'],
        triggers: {},
    },
]
