...
export const strainsE: Strain[] = [
    ...
    createStrainObject({
        ...
        floweringTime: 8.5,
        floweringTimeRange: '8-9',
        description: 'An indica-dominant hybrid known for its fast flowering time and its sweet, fruity aroma. The effect is strong, physically relaxing, and sedating.',
        agronomic: {
            difficulty: 'Easy',
            yield: 'High',
            height: 'Short',
    ...
    createStrainObject({
        id: 'emerald-headband',
        name: 'Emerald Headband',
        type: StrainType.Hybrid,
        typeDetails: 'Sativa 70% / Indica 30%',
        genetics: 'Headband x OG Kush',
        floweringType: 'Photoperiod',
        thc: 23,
        cbd: 1,
        floweringTime: 9,
        ...
        aromas: ['Diesel', 'Lemon', 'Pine'],
        dominantTerpenes: ['Terpinolene', 'Caryophyllene', 'Limonene'],
    }),
    createStrainObject({
        id: 'emergen-c',
        name: 'Emergen-C',
