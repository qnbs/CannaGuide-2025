...
export const strainsG: Strain[] = [
    ...
    createStrainObject({
        ...
        floweringTime: 9.5,
        floweringTimeRange: '9-10',
        description: 'A genetically complex indica hybrid resulting from rigorous crosses of the finest Californian classics. Glitter Bomb earns its name from the almost absurd crystal formation on its oversized flowers. The extremely high THC concentration produces a heavy, profoundly euphoric, and ultimately sedating profile perfect for late evening hours.',
        agronomic: {
            difficulty: 'Medium',
            yield: 'High',
            height: 'Tall',
    ...
    createStrainObject({
        ...
        floweringTime: 9,
        floweringTimeRange: '8-10',
        description: 'Great White Shark (also known as Peacemaker) by Greenhouse Seeds is a 1997 Cannabis Cup winner. This indica-dominant hybrid delivers an immediate cerebral buzz followed by a strong body stone. Known for its massive resin production and sweet, fruity flavor.',
        agronomic: {
            difficulty: 'Easy',
            yield: 'High',
            height: 'Medium',
    ...
    createStrainObject({
        ...
        floweringTime: 9,
        floweringTimeRange: '8-10',
        description: 'Guava by Cookies is a flavorful hybrid known for its tropical, guava-forward terpene profile. It delivers a balanced high combining cerebral stimulation with body relaxation. The buds are dense, colorful, and coated in trichomes with green and purple hues.',
        agronomic: {
            difficulty: 'Medium',
            yield: 'Medium',
            height: 'Medium',
