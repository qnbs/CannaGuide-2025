...
export const strainsK: Strain[] = [
    createStrainObject({
        ...
        description:
            'An indica-dominant strain known for its fast flowering time and its dense, resinous buds. The effect is relaxing and calming.',
        thc: 18,
        cbd: 1,
        thcRange: '16-20%',
        cbdRange: '<1%',
    ...
    createStrainObject({
        ...
        genetics: 'Colombian x Thai',
        floweringType: 'Photoperiod',
        description:
            "An award-winning, almost pure Sativa. It is known for its energizing, clear, and creative effect, which makes it the 'Queen of Sativas'. The exact genetics are unknown, but it is believed to descend from classic Sativa landraces. Ideal for daytime use.",
        thc: 20,
        cbd: 1,
        thcRange: '18-22%',
        cbdRange: '<1%',
    ...
    createStrainObject({
        ...
        floweringType: 'Photoperiod',
        description:
            'An indica-dominant strain with a sweet, candy-like aroma. The effect is strong, relaxing, and euphoric.',
        thc: 20,
        cbd: 1,
        thcRange: '18-22%',
        cbdRange: '<1%',
    ...
    createStrainObject({
        ...
        floweringType: 'Photoperiod',
        description:
            'A pure Indica landrace from the Ketama region of Morocco, traditionally used for making high-quality hashish. It offers a relaxing and calming effect.',
        thc: 18,
        cbd: 1,
        thcRange: '15-20%',
        cbdRange: '<1%',
    ...
    createStrainObject({
        ...
        floweringType: 'Photoperiod',
        description:
            'A Girl Scout Cookies phenotype with a distinct lime and mint aroma. The effect is relaxing and euphoric, ideal for evening use.',
        thc: 22,
        cbd: 1,
        thcRange: '20-24%',
        cbdRange: '<1%',
    ...
    createStrainObject({
        ...
        floweringType: 'Photoperiod',
        description:
            'A potent indica-dominant strain developed for the rapper Wiz Khalifa. Known for its strong, lemony, and piney aroma and its relaxing, euphoric effect.',
        thc: 27,
        cbd: 2,
        thcRange: '24-30%',
        cbdRange: '<2%',
    ...
    createStrainObject({
        ...
        floweringTimeRange: '10-12',
        description:
            "A pure African Sativa from the slopes of Kilimanjaro in Kenya. It is known for its extremely energizing and almost immediate effect, which has earned it the nickname 'one-hit-wonder'. Ideal for daytime use to promote activity and creativity.",
        agronomic: {
            difficulty: 'Medium',
            yield: 'High',
            height: 'Tall',
    ...
    createStrainObject({
        ...
        floweringTimeRange: '8-10',
        description:
            'A potent indica-dominant strain with an earthy, spicy aroma. The effect is strong, physically relaxing, and sedating.',
        agronomic: {
            difficulty: 'Medium',
            yield: 'Medium',
            height: 'Short',
    ...
    createStrainObject({
        ...
        description:
            'A rare phenotype of OG Kush, known for its extremely pungent, piney, and earthy aroma. The effect is strong, sedating, and ideal for insomnia.',
        agronomic: {
            difficulty: 'Medium',
            yield: 'Medium',
            height: 'Short',
    ...
    createStrainObject({
        ...
        description:
            "An indica-dominant strain with a sweet, grape-like, and earthy aroma. The 'Grape' parent is believed to be Grape Ape. The effect is strong, relaxing, and long-lasting.",
        agronomic: {
            difficulty: 'Medium',
            yield: 'High',
            height: 'Medium',
    ...
    createStrainObject({
        ...
        floweringTimeRange: '9-10',
        description:
            'The first strain to be blessed by a rabbi. This award-winning indica-dominant hybrid offers a strong, physically relaxing effect and an earthy, fruity taste.',
        agronomic: {
            difficulty: 'Medium',
            yield: 'High',
            height: 'Medium',
    ...
    createStrainObject({
        ...
        floweringTimeRange: '8-10',
        description:
            'An indica-dominant strain with a sweet, creamy, and fruity aroma. The effect is relaxing and calming, ideal for evening use.',
        agronomic: {
            difficulty: 'Easy',
            yield: 'Medium',
            height: 'Short',
    ...
    createStrainObject({
        ...
        genetics: 'Thai x Brazilian x Afghani',
        floweringType: 'Photoperiod',
        thc: 18,
        cbd: 1,
        floweringTime: 8,
    ...
    createStrainObject({
        ...
        cbd: 1,
        floweringTime: 8.5,
        aromas: ['Sweet', 'Earthy', 'Pine', 'Citrus'],
        dominantTerpenes: ['Myrcene', 'Limonene', 'Caryophyllene'],
    }),
    createStrainObject({
        id: 'killer-new-haven',
    ...
    createStrainObject({
        ...
        cbdRange: 'Unknown',
        floweringTime: 18,
        floweringTimeRange: '16-20',
        description:
            'Kerala Gold is a near-pristine sativa landrace from the Western Ghats of India and one of the rarest foundation genetics. It has adapted to equatorial photoperiods and exhibits exceptional resistance to mold and mildew. The high is profoundly refreshing and cerebrally focused, accompanied by a complex aroma profile of fine sandalwood, spices, and sour floral notes.',
        agronomic: {
            difficulty: 'Hard',
            yield: 'Medium',
            height: 'Tall',
            yieldDetails: { indoor: 'Variable', outdoor: 'Variable' },
            heightDetails: { indoor: 'Variable', outdoor: '>200 cm' },
        },
        aromas: ['Floral', 'Woody', 'Sour', 'Spicy', 'Sandalwood'],
        dominantTerpenes: ['Pinene', 'Limonene', 'Myrcene'],
    }),
]
