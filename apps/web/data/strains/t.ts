...
,
    ...
    createStrainObject({
        ...
        floweringTimeRange: '8-10',
        description:
            'Think Tank has generated immense attention in the extraction industry through extremely high, lab-verified THC readings up to an exorbitant 41%. The strain magnificently balances the dense, savory doughiness of Wedding Cake with sharp Lemon Tree citrus fruit. The mentally incredibly focusing high is accompanied by a warm, functional body sensation.',
        agronomic: {
            difficulty: 'Hard',
            yield: 'Medium',
            height: 'Medium',
