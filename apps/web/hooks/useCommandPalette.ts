...
export const useCommandPalette = (): { allCommands: Command[] } => {
    ...
    const allCommands: Command[] = useMemo(
        () => [
            ...
            {
                id: 'lang_es',
                title: t('commandPalette.toggleLanguage', { lang: 'Espanol' }),
                group: 'General',
                icon: PhosphorIcons.Globe,
                action: () => dispatch(setSetting({ path: 'general.language', value: 'es' })),
                keywords: 'language spanish espanol es switch locale idioma',
            },
            {
                id: 'lang_fr',
                title: t('commandPalette.toggleLanguage', { lang: 'Francais' }),
                group: 'General',
                icon: PhosphorIcons.Globe,
                action: () => dispatch(setSetting({ path: 'general.language', value: 'fr' })),
                keywords: 'language french francais fr switch locale langue',
            },
            {
                id: 'lang_nl',
                title: t('commandPalette.toggleLanguage', { lang: 'Nederlands' }),
                group: 'General',
                icon: PhosphorIcons.Globe,
                action: () => dispatch(setSetting({ path: 'general.language', value: 'nl' })),
                keywords: 'language dutch nederlands nl switch locale taal',
            },
        ],
