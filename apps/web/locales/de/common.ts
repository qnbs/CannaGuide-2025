export const common = {
    ...
    accessibility: {
        ...
        comparisonChart: 'Liniendiagramm zum Vergleich von Hoehe und Gesundheit der Pflanzen',
        environmentTemperatureChart:
            'Diagramm mit Temperatur und Luftfeuchtigkeit im Grow-Raum ueber die Zeit',
        environmentVpdChart: 'Diagramm mit dem Dampfdruckdefizit im Grow-Raum',
        environmentNutrientChart: 'Diagramm mit pH, EC und Wassermenge ueber die Zeit',
        strainCannabinoidBalanceChart:
            'Kreisdiagramm mit der Cannabinoid-Balance: THC, CBD, Sonstige',
        strainCannabinoidChart: 'Balkendiagramm zum Vergleich von THC- und CBD-Gehalt',
        strainTerpeneChart: 'Radardiagramm mit dem Terpenprofil',
        strainFlavonoidChart: 'Balkendiagramm mit den Flavonoid-Entourage-Werten',
        analyticsStrainTypeChart:
            'Kreisdiagramm mit der Verteilung deiner Pflanzen auf die Sortentypen',
        analyticsJournalChart: 'Flaechendiagramm mit den Journal-Eintraegen der letzten 14 Tage',
        analyticsHealthChart:
            'Flaechendiagramm mit der durchschnittlichen Pflanzengesundheit ueber die Zeit',
        analyticsStrainPerformanceChart: 'Balkendiagramm zum Leistungsvergleich nach Sorte',
        /** Spaltenueberschriften der Screenreader-Tabelle zu jedem Diagramm. */
        chart: {
            hour: 'Stunde',
            day: 'Tag',
            date: 'Datum',
            ...
            terpene: 'Terpen',
            vpd: 'VPD (kPa)',
            targetVpd: 'Ziel-VPD (kPa)',
            temperature: 'Temperatur (°C)',
            humidity: 'Luftfeuchtigkeit (%)',
            water: 'Wasser (ml)',
            ph: 'pH',
            ec: 'EC (mS/cm)',
            waterTemperature: 'Wassertemperatur (°C)',
            height: 'Hoehe (cm)',
            health: 'Gesundheit (%)',
            yield: 'Ertrag (g)',
            count: 'Anzahl',
