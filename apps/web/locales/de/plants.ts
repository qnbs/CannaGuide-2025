export const plantsView = {
    ...
    dailySimulation: {
        stageChangeJournal: 'Stadium gewechselt von {{from}} zu {{to}}',
        waterTaskTitle: 'Pflanze giessen',
        waterTaskDescription: '{{name}} braucht Wasser.',
    },
    autoScheduler: {
        title: 'Auto-Planung',
        description:
