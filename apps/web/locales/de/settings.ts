export const settingsView = {
    ...
    offlineAi: {
        ...
        // LLM-Modellauswahl
        modelSelector: {
            title: 'LLM-Modellauswahl',
            subtitle: 'Waehle welches lokale KI-Modell fuer Textgenerierung verwendet wird.',
            autoLabel: 'Auto (Empfohlen)',
            autoDesc: 'Waehlt automatisch das beste Modell fuer dein Geraet.',
            currentAuto: 'Dein Geraet: {{model}}',
    ...
    about: {
        ...
        credits: {
            ...
            onnx: 'ML-Runtime durch ONNX Runtime Web.',
    ...
    grows: {
        title: 'Grow-Verwaltung',
        subtitle: '{{count}} von {{max}} Grows',
        createGrow: 'Neuer Grow',
        editGrow: 'Grow bearbeiten',
        name: 'Name',
        namePlaceholder: 'z.B. Indoor Winter 2025',
        description: 'Beschreibung',
        descriptionPlaceholder: 'Optionale Notizen zu diesem Grow',
        color: 'Farbe',
        activate: 'Aktivieren',
        active: 'Aktiv',
        archive: 'Archivieren',
        ...
        plantCount_one: '{{count}} Pflanze',
        plantCount_other: '{{count}} Pflanzen',
        statsPlants_one: '{{count}} Pflanze',
        statsPlants_other: '{{count}} Pflanzen',
        statsJournal_one: '{{count}} Eintrag',
        statsJournal_other: '{{count}} Eintraege',
        statsHealth: 'Gesundheit: {{value}}%',
    ...
    zipBackup: {
        ...
        importZipDesc: 'Daten aus einem zuvor exportierten ZIP-Archiv wiederherstellen.',
        exporting: 'ZIP-Archiv wird erstellt...',
        importing: 'Wiederherstellung aus ZIP...',
        exportSuccess: 'ZIP-Backup erfolgreich exportiert.',
        importSuccess: 'ZIP-Backup erfolgreich importiert. App wird neu geladen.',
        importError:
            'ZIP-Backup konnte nicht importiert werden. Die Datei ist moeglicherweise beschaedigt.',
        exportError: 'ZIP-Backup konnte nicht erstellt werden.',
        includePhotos: 'Fotos einschliessen',
    ...
    csvExport: {
        ...
        exportNutrients: 'Naehrstoff-Messwerte exportieren (CSV)',
    ...
    workerTelemetry: {
        ...
        sabActive: 'SAB-Modus: Aktiv',
        sabFallback: 'Fallback: Transferable',
        poolStatus: 'Pool-Status',
        noPool: 'Worker-Pool nicht initialisiert',
        active: 'Aktiv',
        idle: 'Leerlauf',
        spawned: 'Gestartet',
        terminated: 'Beendet',
        maxPool: 'Max. Pool-Groesse',
        perWorker: 'Worker-Metriken',
        noWorkers: 'Keine aktiven Worker',
        workerName: 'Worker',
        dispatches: 'Aufrufe',
        errors: 'Fehler',
        avgLatency: 'Mittl. Latenz',
