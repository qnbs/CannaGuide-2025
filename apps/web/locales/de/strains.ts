export const strainsView = {
    ...
    dailyStrains: {
        ...
        noSearchResults: 'Keine Ergebnisse fuer deine Suche gefunden.',
        allDismissed: 'Du hast alle Picks von heute gesehen. Komm morgen fuer frische Drops!',
        lastUpdated: 'Zuletzt aktualisiert: {{date}}',
        dismiss: 'Ausblenden',
        addToLibrary: 'Zur Bibliothek',
        editAndAdd: 'Bearbeiten und hinzufuegen',
    ...
    cansativa: {
        ...
        pzn: 'PZN',
        medicalGrade: 'Medizinische Qualitaet',
        pharmacyOnly: 'Nur ueber Apotheke erhaeltlich',
        origin: 'Herkunft',
