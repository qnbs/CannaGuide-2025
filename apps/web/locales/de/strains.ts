export const strainsView = {
    ...
    dailyStrains: {
        title: 'Tägliche Sorten-Entdeckungen',
        subtitle: 'Frische Sorten aus der Community -- taeglich aktualisiert via SeedFinder',
        newCount: '{{count}} neu',
        updatedCount: '{{count}} aktualisiert',
        catalogSize: '{{count}} im Katalog',
        searchPlaceholder: 'SeedFinder nach neuen Sorten durchsuchen...',
        search: 'Suchen',
        ...
        noDiscoveries: 'Heute keine neuen Sorten-Entdeckungen. Schau morgen wieder vorbei!',
        lastUpdated: 'Zuletzt aktualisiert: {{date}}',
        dismiss: 'Ausblenden',
        addToLibrary: 'Zur Bibliothek hinzufuegen',
