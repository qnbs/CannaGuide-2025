...
export const equipmentView = {
    ...
    nutrientBrands: {
        title: 'Nutrient Brand Schedules',
        selectBrand: 'Select a nutrient brand',
        noBrand: 'Manual (no brand schedule)',
        applySchedule: 'Apply Schedule',
        appliedSuccess: 'Brand schedule applied: {{brand}}',
        weekLabel: 'Week {{week}}',
        stageLabel: 'Stage: {{stage}}',
        ecTarget: 'EC Target: {{value}}',
        phRange: 'pH Range: {{min}} - {{max}}',
        products: 'Products',
        dosage: '{{dosage}} ml/L',
        flushWeek: 'Flush Week',
