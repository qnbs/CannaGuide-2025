export const knowledgeView = {
    ...
    scenarios: {
        ...
        humidityPlus10: {
            title: 'Humidity +10% Experiment',
            description: 'Simulates 14 days with +10% relative humidity to analyze mold risk.',
        },
        humidityMinus10: {
            title: 'Humidity -10% Experiment',
            description: 'Simulates 14 days with -10% relative humidity for VPD optimization.',
        },
        lightBoost: {
            title: 'Light Intensity +200 PPFD',
            description: 'Simulates 14 days with increased light intensity (+200 PPFD).',
        },
        phDriftAcidic: {
            title: 'pH Drift to 5.5',
            description: 'Simulates a gradual pH drift to 5.5 over 14 days.',
        },
        ecRampUp: {
            title: 'EC Ramp-Up +0.5',
            description: 'Simulates a gradual EC increase of 0.5 over 14 days.',
        },
        defoliationDay7: {
            title: 'Defoliation on Day 7',
            description: 'Simulates a defoliation event on day 7 and its effects over 14 days.',
        },
    },
    knowledgebase: {
        'phase1-prep': {
    ...
    sandbox: {
        ...
        actionLabels: {
            ...
            HUMIDITY_PLUS_10: 'Humidity +10%',
            HUMIDITY_MINUS_10: 'Humidity -10%',
            LIGHT_BOOST: 'Light +200 PPFD',
            PH_DRIFT_ACIDIC: 'pH Drift (acidic)',
            EC_RAMP: 'EC Ramp-Up',
    ...
    lernpfad: {
        ...
        progressLabel: '{{done}} of {{total}} steps',
...
export const analytics = {
    ...
    recommendations: {
        ...
        phDrift: 'pH Drift Detected',
        phDriftDesc: 'pH is drifting outside the optimal 5.8-6.8 range. Calibrate and adjust.',
        ecRampUp: 'Increase EC for Flowering',
        ecRampUpDesc: 'EC is low for flowering stage. Gradually increase nutrient concentration.',
        defoliation: 'Consider Defoliation',
        defoliationDesc:
            'Plant is mature with good health. Selective defoliation may improve light penetration.',
    },
    healthTrend: 'Health Trend (14d)',
    nutrientConsistency: 'Nutrient Consistency',
    nutrientRating: {
        stable: 'Stable',
        moderate: 'Moderate',
        unstable: 'Unstable',
    },
    growDuration: 'Grow Duration by Strain',
    growDurationMin: 'Min',
    growDurationMax: 'Max',
    growDurationAvg: 'Avg',
    growDurationCount: 'Harvests',
    noFinishedGrows: 'No completed grows yet.',
    journalTrend: 'Journal Activity (14d)',
    ...
    predictive: {
        ...
        noData: 'Not enough sensor data for predictions',
        samples: 'samples',
