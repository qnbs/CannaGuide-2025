export const settingsView = {
    ...
    categories: {
        ...
        workerTelemetry: 'Worker Telemetry',
    },
    security: {
        ...
        providerConsentDeny: 'Use local AI instead',
    ...
    offlineAi: {
        ...
        modelSelector: {
            ...
            model_05B_desc: 'Ultra-light model for any device. Fast but limited quality.',
        ...
        ecoAutoActivatedToast: 'Eco mode auto-activated due to low battery (<25%).',
        ecoAutoDeactivatedToast:
            'Battery recovered -- eco mode deactivated, returning to hybrid mode.',
        oomPressureToast:
    ...
    tts: {
        ...
        voiceControl: {
            ...
            offlineStt: 'Offline Speech Recognition',
            offlineSttDesc:
                'Uses Whisper-Tiny (75 MB) for on-device speech recognition when offline. First use requires a one-time model download.',
            offlineSttStatus: 'Model Status',
            offlineSttReady: 'Ready',
            offlineSttLoading: 'Loading...',
            offlineSttNotLoaded: 'Not loaded',
            offlineSttUnavailable: 'Not supported in this browser',
        },
        commands: {
    ...
    voice: {
        wakeWord: {
            ...
            engineDesc: 'Choose the engine that listens for the wake word.',
            regex: 'Regex (built-in)',
            porcupine: 'Porcupine (WASM)',
            accessKey: 'Porcupine Access Key',
            accessKeyDesc: 'Your Picovoice access key. Stored encrypted locally.',
            accessKeyPlaceholder: 'Enter Porcupine access key...',
            keyword: 'Wake Keyword',
        },
        cloudTts: {
            title: 'Cloud TTS (optional)',
            enabled: 'Enable Cloud TTS',
            enabledDesc: 'Use a cloud text-to-speech provider for higher voice quality.',
            provider: 'Provider',
            apiKey: 'API Key',
            apiKeyDesc: 'Your provider API key. Encrypted locally, never sent to our servers.',
            apiKeyPlaceholder: 'Enter API key...',
            privacyNote: 'Your API key is encrypted locally. No data is sent to our servers.',
        },
        advanced: {
            title: 'Advanced Voice Options',
            workerEnabled: 'Voice Worker (off-thread)',
            workerEnabledDesc:
                'Process voice commands in a background worker. Enables dynamic waveform and smoother UI.',
            analyticsEnabled: 'Voice Analytics (opt-in)',
            analyticsEnabledDesc:
                'Collect anonymous usage statistics. No transcripts or personal data are stored.',
            ...
            hotwordCount: 'Hotword Detections',
        },
    },
    strains: {
    ...
    data: {
        ...
        restoreBlocked: 'Data restore is temporarily blocked by a safe recovery operation.',
        resetError: 'Data reset could not be completed. Your saved data was not changed.',
        sliceResetError: 'This data section could not be reset. Your saved data was not changed.',
    ...
    about: {
        ...
        credits: {
            ...
            onnx: 'ML runtime by ONNX Runtime Web.',
        ...
        devJourney: {
            ...
            phase4Desc: 'Production deployment to GitHub Pages, Vercel, and Cloudflare Pages.',
        ...
        `,
            ...
            <ol>
                ...
                <li><strong>Deployment</strong>: Production via GitHub Pages, Vercel, and Cloudflare Pages.</li>
            </ol>
    ...
    zipBackup: {
        title: 'ZIP Backup',
        description: 'Export and restore your complete grow data including photos.',
        exportZip: 'Export ZIP Backup',
        exportZipDesc: 'Export all data including photos as a ZIP archive.',
        importZip: 'Import ZIP Backup',
        importZipDesc: 'Restore data from a previously exported ZIP archive.',
        exporting: 'Creating ZIP archive...',
        importing: 'Restoring from ZIP...',
        exportSuccess: 'ZIP backup exported successfully.',
        importSuccess: 'ZIP backup imported successfully. App will reload.',
        importError: 'Failed to import ZIP backup. The file may be corrupted.',
        exportError: 'Failed to create ZIP backup.',
    ...
    csvExport: {
        title: 'CSV Export',
        description: 'Export plant data and tasks as CSV files for spreadsheet analysis.',
        exportPlants: 'Export Plants (CSV)',
        exportTasks: 'Export Tasks (CSV)',
        exportCsv: 'Export CSV',
        exportMetrics: 'Export Plant Metrics (CSV)',
        exportJournal: 'Export Journal Entries (CSV)',
        exportNutrients: 'Export Nutrient Readings (CSV)',
        exportSuccess: 'CSV exported successfully.',
        exportError: 'Failed to export CSV.',
        noData: 'No data available for export.',
    },
    iot: {
        title: 'Hardware & IoT Sensors',
        description:
            'Connect ESP32 or other MQTT-compatible sensors via WebSocket to log environment data automatically.',
        enableLabel: 'Enable IoT Sensors',
        enableDesc: 'When enabled, the app will subscribe to MQTT topics for live sensor data.',
        ...
        brokerUrlHint: 'WebSocket URL (ws:// or wss://) of your MQTT broker',
        username: 'Username (optional)',
        password: 'Password (optional)',
        topicPrefix: 'Topic Prefix',
        topicPrefixHint: 'The app subscribes to {prefix}/+/temperature, {prefix}/+/humidity, etc.',
        testing: 'Testing...',
        testConnection: 'Test Connection',
        telemetryTitle: 'MQTT Telemetry',
        messages: 'Messages',
    ...
    workerTelemetry: {
        ...
        sabActive: 'SAB Mode: Active',
        sabFallback: 'Fallback: Transferable',
        poolStatus: 'Pool Status',
        noPool: 'Worker pool not initialized',
        active: 'Active',
        idle: 'Idle',
        spawned: 'Spawned',
        terminated: 'Terminated',
        maxPool: 'Max pool size',
        perWorker: 'Per-Worker Metrics',
        noWorkers: 'No workers active',
        workerName: 'Worker',
        ...
        sabLiveData: 'Live SAB Data',
        sabVpdStatus: 'VPD Status',
        sabVpdValue: 'VPD Value',
        sabNoData: 'No SAB data available (requires cross-origin isolation)',
        sabBufferUtil: 'Buffer Utilization',
    },
}
