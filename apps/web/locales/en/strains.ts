export const strainsView = {
    ...
    dailyStrains: {
        title: 'Daily Strain Discoveries',
        subtitle: 'Fresh strains from the community -- updated daily via SeedFinder',
        newCount: '{{count}} new',
        updatedCount: '{{count}} updated',
        catalogSize: '{{count}} in catalog',
        searchPlaceholder: 'Search SeedFinder for new strains...',
        search: 'Search',
        searchResultCount: '{{count}} results found',
        clearSearch: 'Clear search',
        noSearchResults: 'No results found for your search.',
        noDiscoveries: 'No new strain discoveries today. Check back tomorrow!',
