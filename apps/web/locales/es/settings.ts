export const settingsView = {
    ...
    categories: {
        ...
        workerTelemetry: 'Telemetria de Workers',
    },
    security: {
    ...
    tts: {
        ...
        voiceControl: {
            ...
            offlineStt: 'Reconocimiento de Voz Offline',
            offlineSttDesc:
                'Usa Whisper-Tiny (75 MB) para reconocimiento de voz en el dispositivo cuando no hay conexion. El primer uso requiere una descarga unica del modelo.',
            offlineSttStatus: 'Estado del Modelo',
            offlineSttReady: 'Listo',
            offlineSttLoading: 'Cargando...',
            offlineSttNotLoaded: 'No cargado',
            offlineSttUnavailable: 'No compatible con este navegador',
        },
        commands: {
    ...
    about: {
        ...
        version: 'Version',
        whatsNew: {
            title: 'Novedades en v1.8',
            items: {
                simulation:
                    'Voice Pro: Deteccion de palabra clave WASM Porcupine (11 palabras), ElevenLabs Cloud TTS y orquestador de voz de 37 comandos con HUD de forma de onda.',
                strains:
                    'Boveda de Semillas con resultados de cosecha, registro de polen y almacenamiento de semillas. Rediseno UI glassmorphism en todas las vistas principales.',
                help: 'HydroMonitor con pronostico ONNX pH/EC/Temp, panel de analisis predictivo y panel de indicadores en tiempo real con graficos de tendencias.',
                settings:
                    'Worker Pool W-06 con generacion lazy, timeout inactivo y exencion hot-worker. Advertencias de accesibilidad reducidas de 202 a 83. 2253 pruebas automatizadas.',
            },
        },
        techStack: {
    ...
    zipBackup: {
        ...
        importZipDesc: 'Restaurar datos desde un archivo ZIP exportado previamente.',
        exporting: 'Creando archivo ZIP...',
        importing: 'Restaurando desde ZIP...',
        exportSuccess: 'Copia ZIP exportada con exito.',
        importSuccess: 'Copia ZIP importada con exito. La app se recargara.',
        importError: 'No se pudo importar la copia ZIP. El archivo puede estar corrupto.',
        exportError: 'No se pudo crear la copia ZIP.',
    ...
    csvExport: {
        ...
        exportNutrients: 'Exportar lecturas de nutrientes (CSV)',
    ...
    workerTelemetry: {
        title: 'Telemetria de Workers',
        sabActive: 'Modo SAB: Activo',
        sabFallback: 'Fallback: Transferable',
        poolStatus: 'Estado del Pool',
        noPool: 'Pool de workers no inicializado',
        active: 'Activos',
        idle: 'Inactivos',
        spawned: 'Creados',
        terminated: 'Terminados',
        maxPool: 'Tamanio max. del pool',
        perWorker: 'Metricas por Worker',
        noWorkers: 'No hay workers activos',
        workerName: 'Worker',
