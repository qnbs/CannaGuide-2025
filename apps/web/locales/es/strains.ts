export const strainsView = {
    ...
    seedVault: {
        ...
        empty: 'Tu banco de semillas esta vacio. Agrega semillas de cosechas o compras.',
        addSeed: 'Agregar semilla',
        editSeed: 'Editar semilla',
        ...
        breeder: 'Criador / Fuente',
        quality: 'Calidad',
        qualityRating: 'Valoracion de calidad',
        stars: '{{count}} estrellas',
        stars_one: '{{count}} estrella',
        stars_other: '{{count}} estrellas',
        acquiredOn: 'Adquirida el {{date}}',
        acquiredDate: 'Fecha de adquisicion',
        customDate: 'Fecha personalizada',
        notes: 'Notas',
        tags: 'Etiquetas',
        addTag: 'Agregar etiqueta',
        removeTag: 'Eliminar etiqueta',
        tagPlaceholder: 'Agregar etiqueta y pulsar Enter...',
        totalSeeds: '{{count}} semillas',
        totalSeeds_one: '{{count}} semilla',
        totalSeeds_other: '{{count}} semillas',
        storageLocation: 'Ubicacion de almacenamiento',
        storageLocationPlaceholder: 'ej. Refrigerador, Cajon, Caja fuerte...',
        germinationRate: 'Tasa de germinacion',
        batchNumber: 'Numero de lote',
        source: 'Origen',
        sources: {
            purchase: 'Compra',
            harvest: 'Cosecha',
        ...
        viabilityGood: 'Buena viabilidad',
        viabilityDeclining: 'Viabilidad en declive',
        viabilityExpired: 'Viabilidad en riesgo',
        confirmDelete: 'Confirmar eliminacion',
        confirmDeleteMsg: 'Estas seguro de eliminar "{{name}}"? Esto no se puede deshacer.',
        confirmDeleteBulk: 'Eliminar {{count}} entradas seleccionadas?',
        stats: {
        ...
        bulkDelete: 'Eliminar seleccion',
        bulkTag: 'Etiquetar seleccion',
        selectAll: 'Seleccionar todo',
        deselectAll: 'Deseleccionar todo',
        selectedCount: '{{count}} seleccionados',
        expandDetails: 'Mostrar detalles',
        collapseDetails: 'Ocultar detalles',
        consumeForGrow: 'Usar para cultivo',
        consumeConfirm: 'Usar 1 semilla de "{{name}}" para un cultivo?',
        consumeSuccess: 'Semilla consumida del inventario.',
        listView: 'Vista de lista',
        gridView: 'Vista de cuadricula',
        noResults: 'Ninguna semilla coincide con tus filtros.',
        clearFilters: 'Limpiar filtros',
        importFromCatalog: 'Desde catalogo',
        selectStrain: 'Seleccionar cepa',
        inStock: 'En stock',
        outOfStock: 'Sin stock',
        lowStockLabel: 'Stock bajo',
        filterByType: 'Filtrar por tipo',
        filterByStock: 'Filtrar por stock',
        stockAll: 'Todo el stock',
        ...
        strainNamePlaceholder: 'Ingrese nombre de cepa...',
        cancel: 'Cancelar',
        save: 'Guardar',
        searchPlaceholder: 'Buscar semillas...',
        allTypes: 'Todos los tipos',
        decrease: 'Disminuir cantidad',
        increase: 'Aumentar cantidad',
        remove: 'Eliminar semilla',
        pollenSection: {
            title: 'Registro de polen',
            addRecord: 'Registrar polen',
            editRecord: 'Editar registro',
            viable: 'Viable',
            notViable: 'No viable',
            storageLocation: 'Ubicacion de almacenamiento',
            donor: 'Cepa donante',
            collectedDate: 'Fecha de recoleccion',
            empty: 'Sin registros de polen todavia.',
            remove: 'Eliminar registro',
            confirmRemove: 'Eliminar este registro de polen?',
            notes: 'Notas',
            donorPlaceholder: 'Nombre de cepa donante...',
            storagePlaceholder: 'ej. Congelador, Gel de silice...',
            filterViable: 'Solo viables',
...
export const strainLookup = {
    ...
    confidenceTooltip: '{{label}} -- {{score}} % confianza',
}
