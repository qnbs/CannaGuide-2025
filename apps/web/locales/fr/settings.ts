export const settingsView = {
    ...
    categories: {
        ...
        workerTelemetry: 'Telemetrie des Workers',
    },
    security: {
        ...
        providerConsentDeny: "Utiliser l'IA locale a la place",
    ...
    notifications: {
        ...
        browserBlocked:
            'Les notifications du navigateur sont bloquees. Veuillez autoriser les notifications dans les parametres de votre navigateur pour recevoir les alertes de culture.',
        browserUnsupported: 'Ce navigateur ne prend pas en charge les notifications push.',
    ...
    about: {
        ...
        devJourney: {
            ...
            phase4Desc: 'Deploiement en production sur GitHub Pages, Vercel et Cloudflare Pages.',
        ...
        `,
            ...
            <ol>
                ...
                <li><strong>Deploiement</strong> : Production via GitHub Pages, Vercel et Cloudflare Pages.</li>
            </ol>
    ...
    grows: {
        ...
        archiveConfirmDesc:
            'Voulez-vous vraiment archiver cette culture? Vous pourrez la restaurer plus tard.',
    ...
    zipBackup: {
        ...
        description: 'Exportez et restaurez vos donnees de culture completes, photos incluses.',
        exportZip: 'Exporter sauvegarde ZIP',
        exportZipDesc: 'Exporter toutes les donnees y compris les photos en archive ZIP.',
        importZip: 'Importer sauvegarde ZIP',
        importZipDesc: 'Restaurer les donnees depuis une archive ZIP precedemment exportee.',
        exporting: "Creation de l'archive ZIP...",
        importing: 'Restauration depuis ZIP...',
        exportSuccess: 'Sauvegarde ZIP exportee avec succes.',
        importSuccess: "Sauvegarde ZIP importee avec succes. L'app va se recharger.",
        importError: "Impossible d'importer la sauvegarde ZIP. Le fichier est peut-etre corrompu.",
        exportError: 'Impossible de creer la sauvegarde ZIP.',
    ...
    csvExport: {
        title: 'Export CSV',
        description:
            'Exportez les donnees de plantes et taches en fichiers CSV pour analyse tableur.',
        exportPlants: 'Exporter Plantes (CSV)',
        exportTasks: 'Exporter Taches (CSV)',
        exportCsv: 'Exporter CSV',
        exportMetrics: 'Exporter les metriques des plantes (CSV)',
        exportJournal: 'Exporter les entrees du journal (CSV)',
        exportNutrients: 'Exporter les lectures nutritives (CSV)',
        exportSuccess: 'CSV exporte avec succes.',
        exportError: "Echec de l'export CSV.",
        noData: "Aucune donnee disponible pour l'export.",
    },
    iot: {
        title: 'Materiel & Capteurs IoT',
        description:
            'Connectez des capteurs ESP32 ou autres compatibles MQTT via WebSocket pour enregistrer automatiquement les donnees environnementales.',
        enableLabel: 'Activer les capteurs IoT',
        enableDesc:
            "Lorsqu'active, l'app s'abonne aux topics MQTT pour les donnees de capteurs en direct.",
        statusLabel: 'Etat de Connexion',
        statusDisconnected: 'Deconnecte',
        statusConnecting: 'Connexion en cours...',
        statusConnected: 'Connecte',
        statusError: 'Erreur',
        brokerUrl: 'URL du Broker MQTT',
        brokerUrlHint: 'URL WebSocket (ws:// ou wss://) de votre broker MQTT',
        username: "Nom d'utilisateur (optionnel)",
        password: 'Mot de passe (optionnel)',
        topicPrefix: 'Prefixe de Topic',
        topicPrefixHint: "L'app s'abonne a {prefix}/+/temperature, {prefix}/+/humidity, etc.",
        testing: 'Test en cours...',
        testConnection: 'Tester la Connexion',
        telemetryTitle: 'Telemetrie MQTT',
        messages: 'Messages',
    ...
    workerTelemetry: {
        title: 'Telemetrie des Workers',
        sabActive: 'Mode SAB : Actif',
        sabFallback: 'Fallback : Transferable',
        poolStatus: 'Etat du Pool',
        noPool: 'Pool de workers non initialise',
        active: 'Actifs',
        idle: 'Inactifs',
        spawned: 'Crees',
        terminated: 'Termines',
        maxPool: 'Taille max. du pool',
        perWorker: 'Metriques par Worker',
        noWorkers: 'Aucun worker actif',
        workerName: 'Worker',
        dispatches: 'Envois',
        errors: 'Erreurs',
