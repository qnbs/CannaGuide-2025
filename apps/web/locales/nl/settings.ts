export const settingsView = {
    ...
    categories: {
        ...
        grows: 'Teeltbeheer',
        workerTelemetry: 'Worker Telemetrie',
    },
    security: {
    ...
    offlineAi: {
        ...
        autoPreloadHint:
            'Haalt de offline AI-modellen op de achtergrond op bij het starten. Standaard uit -- dit zijn enkele honderden megabytes van de HuggingFace-CDN. Wordt automatisch overgeslagen op datalimiet- of trage verbindingen.',
        forceWasmHint:
    ...
    about: {
        ...
        credits: {
            ...
            onnx: 'ML-runtime door ONNX Runtime Web.',
        ...
        devJourney: {
            ...
            phase4Desc: 'Productie-implementatie naar GitHub Pages, Vercel en Cloudflare Pages.',
        ...
        `,
            ...
            <ol>
                ...
                <li><strong>Implementatie</strong>: Productie via GitHub Pages, Vercel en Cloudflare Pages.</li>
            </ol>
    ...
    grows: {
        title: 'Teeltbeheer',
        subtitle: '{{count}} van {{max}} teelten',
        createGrow: 'Nieuwe teelt',
        editGrow: 'Teelt bewerken',
        name: 'Naam',
        namePlaceholder: 'Bijv. Indoor Winter 2025',
        description: 'Beschrijving',
        descriptionPlaceholder: 'Optionele notities over deze teelt',
        color: 'Kleur',
        activate: 'Activeren',
        active: 'Actief',
        archive: 'Archiveren',
        ...
        archiveConfirmDesc:
            'Weet je zeker dat je deze teelt wilt archiveren? Je kunt deze later herstellen.',
        ...
        statsPlants_other: '{{count}} planten',
        statsJournal_one: '{{count}} vermelding',
        statsJournal_other: '{{count}} vermeldingen',
        statsHealth: 'Gezondheid: {{value}}%',
        statsAge: 'Oudste: {{days}}d',
    },
    zipBackup: {
        title: 'ZIP-back-up',
        description: "Exporteer en herstel je volledige kweekgegevens inclusief foto's.",
        exportZip: 'ZIP-backup exporteren',
        exportZipDesc: "Alle gegevens inclusief foto's exporteren als ZIP-archief.",
        importZip: 'ZIP-backup importeren',
        importZipDesc: 'Gegevens herstellen uit een eerder geexporteerd ZIP-archief.',
        exporting: 'ZIP-archief wordt aangemaakt...',
        importing: 'Herstellen vanuit ZIP...',
        exportSuccess: 'ZIP-backup succesvol geexporteerd.',
        importSuccess: 'ZIP-backup succesvol geimporteerd. App wordt herladen.',
        importError: 'ZIP-backup kon niet worden geimporteerd. Het bestand is mogelijk beschadigd.',
        exportError: 'ZIP-backup kon niet worden aangemaakt.',
        includePhotos: "Foto's opnemen",
        photoCount_one: '{{count}} foto',
        photoCount_other: "{{count}} foto's",
    },
    csvExport: {
        title: 'CSV-export',
        description: 'Exporteer plant- en taakgegevens als CSV-bestanden voor spreadsheet-analyse.',
        exportPlants: 'Planten exporteren (CSV)',
        exportTasks: 'Taken exporteren (CSV)',
        exportCsv: 'CSV exporteren',
        exportMetrics: 'Plantmetingen exporteren (CSV)',
        exportJournal: 'Dagboekitems exporteren (CSV)',
        exportNutrients: 'Voedingsmetingen exporteren (CSV)',
        exportSuccess: 'CSV succesvol geexporteerd.',
        exportError: 'CSV-export mislukt.',
        noData: 'Geen gegevens beschikbaar voor export.',
    },
    iot: {
        title: 'Hardware & IoT-sensoren',
        description:
            'Verbind ESP32 of andere MQTT-compatibele sensoren via WebSocket om automatisch omgevingsgegevens te registreren.',
        enableLabel: 'IoT-sensoren inschakelen',
        enableDesc:
            'Indien ingeschakeld, abonneert de app op MQTT-topics voor live sensorgegevens.',
        statusLabel: 'Verbindingsstatus',
        statusDisconnected: 'Niet verbonden',
        statusConnecting: 'Verbinden...',
        statusConnected: 'Verbonden',
        statusError: 'Fout',
        brokerUrl: 'MQTT Broker URL',
        brokerUrlHint: 'WebSocket URL (ws:// of wss://) van je MQTT broker',
        username: 'Gebruikersnaam (optioneel)',
        password: 'Wachtwoord (optioneel)',
        topicPrefix: 'Topic Prefix',
        topicPrefixHint: 'De app abonneert op {prefix}/+/temperature, {prefix}/+/humidity, enz.',
        testing: 'Testen...',
        testConnection: 'Verbinding Testen',
        telemetryTitle: 'MQTT Telemetrie',
        messages: 'Berichten',
        validRate: 'Geldigheidspercentage',
        latencyMs: 'Latentie (ms)',
        errors: 'Fouten',
    },
    workerTelemetry: {
        title: 'Worker Telemetrie',
        sabActive: 'SAB-modus: Actief',
        sabFallback: 'Fallback: Transferable',
        poolStatus: 'Pool Status',
        noPool: 'Worker pool niet geinitialiseerd',
        active: 'Actief',
        idle: 'Inactief',
        spawned: 'Gestart',
        terminated: 'Beeindigd',
        maxPool: 'Max. pool grootte',
        perWorker: 'Worker Metrieken',
        noWorkers: 'Geen actieve workers',
        workerName: 'Worker',
