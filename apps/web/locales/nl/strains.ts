export const strainsView = {
    ...
    seedVault: {
        ...
        stars: '{{count}} sterren',
        stars_one: '{{count}} ster',
        stars_other: '{{count}} sterren',
        acquiredOn: 'Verkregen op {{date}}',
        acquiredDate: 'Aankoopdatum',
        customDate: 'Aangepaste datum',
        notes: 'Notities',
        tags: 'Tags',
        addTag: 'Tag toevoegen',
        removeTag: 'Tag verwijderen',
        tagPlaceholder: 'Tag invoeren en op Enter drukken...',
        totalSeeds: '{{count}} zaden',
        totalSeeds_one: '{{count}} zaad',
        totalSeeds_other: '{{count}} zaden',
        storageLocation: 'Opslaglocatie',
        storageLocationPlaceholder: 'bijv. Koelkast, Lade, Kluis...',
        germinationRate: 'Kiempercentage',
        ...
        viabilityGood: 'Goede kiemkracht',
        viabilityDeclining: 'Kiemkracht afnemend',
        viabilityExpired: 'Kiemkracht in gevaar',
        confirmDelete: 'Verwijdering bevestigen',
        confirmDeleteMsg:
            'Weet je zeker dat je "{{name}}" wilt verwijderen? Dit kan niet ongedaan worden gemaakt.',
        confirmDeleteBulk: '{{count}} geselecteerde items verwijderen?',
        stats: {
            title: 'Voorraadoverzicht',
            totalEntries: 'Items',
            uniqueStrains: 'Rassen',
        ...
        consumeForGrow: 'Gebruiken voor kweek',
        consumeConfirm: '1 zaad van "{{name}}" gebruiken voor een kweek?',
        consumeSuccess: 'Zaad uit voorraad verbruikt.',
        listView: 'Lijstweergave',
        gridView: 'Rasterweergave',
        noResults: 'Geen zaden komen overeen met je filters.',
        clearFilters: 'Filters wissen',
        importFromCatalog: 'Uit catalogus',
        selectStrain: 'Ras selecteren',
        inStock: 'Op voorraad',
        outOfStock: 'Niet op voorraad',
        lowStockLabel: 'Lage voorraad',
        filterByType: 'Filteren op type',
        filterByStock: 'Filteren op voorraad',
        stockAll: 'Alle voorraad',
        stockInStock: 'Op voorraad',
        stockLow: 'Lage voorraad',
        stockOut: 'Niet op voorraad',
        sortBy: 'Sorteren op',
        addEntry: 'Item toevoegen',
        strainName: 'Rasnaam',
        strainNamePlaceholder: 'Rasnaam invoeren...',
        cancel: 'Annuleren',
        save: 'Opslaan',
        searchPlaceholder: 'Zaden zoeken...',
        allTypes: 'Alle typen',
        decrease: 'Aantal verminderen',
        increase: 'Aantal verhogen',
        remove: 'Zaad verwijderen',
        pollenSection: {
            title: 'Pollenlogboek',
            addRecord: 'Pollen registreren',
            ...
            empty: 'Nog geen pollenregistraties.',
            remove: 'Registratie verwijderen',
            confirmRemove: 'Deze pollenregistratie verwijderen?',
            notes: 'Notities',
            donorPlaceholder: 'Donorrasnaam...',
            storagePlaceholder: 'bijv. Vriezer, Silicagel...',
            filterViable: 'Alleen levensvatbaar',
            showAll: 'Alles tonen',
        },
    },
}
