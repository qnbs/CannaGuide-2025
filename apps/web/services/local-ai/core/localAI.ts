...
import { createInferenceTimer } from './infrastructureService'
import { streamTextGeneration } from '../inference/streamingService'
import { loadWebLlmEngine, getWebLlmModelId } from '../models/webLlmService'
import {
    classifyPlantImage,
...
import { getResolvedProfile } from '../models/modelLoader'
import {
    routeInference,
    getCached,
    setCached,
...
import { LocalAiModelManager } from '../models/modelManager'
import { preloadOfflineAssets, type LocalAiPreloadReport } from '../models/preloadOrchestrator'

export { clearInferenceCache } from './inferenceRouter'
...
class LocalAiService implements BaseAIProvider {
        ...
        return streamTextGeneration(prompt, onToken, {
            ...
            loadWebLlmEngine: () =>
                ...
                loadWebLlmEngine() as ReturnType<
                    import('../inference/streamingService').StreamingDeps['loadWebLlmEngine']
                >,
            getWebLlmModelId,
    ...
    async getWebLlmDiagnostics(): Promise<
        import('../models/webLlmDiagnosticsService').WebLlmDiagnosticResult
    > {
        const { diagnoseWebLlm } = await import('../models/webLlmDiagnosticsService')
        const { getForceWasm } = await import('../models/modelLoader')
