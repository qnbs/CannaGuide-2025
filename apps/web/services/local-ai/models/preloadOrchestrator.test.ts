...
vi.mock('../nlp/languageDetection', () => ({
    preloadLanguageDetectionModel: vi.fn(async () => true),
}))

vi.mock('../vision/imageSimilarityService', () => ({
...
import { preloadOfflineAssets, type LocalAiPreloadReport } from './preloadOrchestrator'
