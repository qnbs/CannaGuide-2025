...
vi.mock('../device/gpuResourceManager', () => ({
...
import { releaseGpu } from '../device/gpuResourceManager'
import { generateWithWebLlm, disposeWebLlm } from './webLlmService'
