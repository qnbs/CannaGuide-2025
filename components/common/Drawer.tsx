                ...
                {title && (
                    <header className="flex-shrink-0 p-4 border-b border-slate-700">
                        ...
                        <div className="flex justify-between items-center">
                            <h2 id="drawer-title" className="text-xl font-bold font-display text-primary-400">{title}</h2>
                            <Button variant="secondary" size="sm" onClick={onClose} className="!p-1.5 !rounded-full">
