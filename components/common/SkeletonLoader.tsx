...
const ListSkeleton: React.FC = () => (
    <div className="glass-pane rounded-lg py-2 animate-pulse grid items-center gap-x-4 px-4 grid-cols-[auto_1fr_auto] sm:grid-cols-[auto_minmax(0,2.5fr)_repeat(6,minmax(0,1fr))_auto]">
        {/* Checkbox */}
...
const GridSkeleton: React.FC = () => (
    <div className="glass-pane rounded-xl p-3 flex flex-col items-center animate-pulse">
