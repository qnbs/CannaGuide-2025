        ...
        >
            ...
            <div className='space-y-4'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 p-3 bg-slate-800/50 rounded-lg'>
                    ...
                    />
                    <InfoRow
                        label={t('strainsView.difficulty.easy')}
                ...
                <div className='grid grid-cols-2 gap-4'>
                        ...
                        <Select
                            ...
                            onChange={(e) =>
                                setSetup((s) => ({
                                    ...
                                    light: {
                                        ...s.light,
                                        type: e.target.value as 'LED' | 'HPS' | 'CFL',
                                    },
                                }))
                            }
                            className='mt-1'
                    ...
                    <div>
                        <label className='text-sm font-semibold'>
                            {t('plantsView.setupModal.wattage')}
                        </label>
                        <Input
                            type='number'
                            ...
                            onChange={(e) =>
                                setSetup((s) => ({
                                    ...s,
                                    light: { ...s.light, wattage: Number(e.target.value) },
                                }))
                            }
                            className='mt-1'
                        />
                    ...
                    <div className='col-span-2'>
                        <RangeSlider
                            ...
                            onChange={(newValue) =>
                                setSetup((prev) => ({ ...prev, potSize: newValue[0] }))
                            }
                            unit=' L'
                        />
                    </div>
                    <div className='col-span-2'>
                        ...
                        <Select
                            ...
                            onChange={(e) =>
                                setSetup((s) => ({
                                    ...s,
                                    medium: e.target.value as 'Soil' | 'Coco' | 'Hydro',
                                }))
                            }
                            className='mt-1'
                            options={[
                    ...
                    <div className='col-span-2'>
                        <RangeSlider
                            ...
                            onChange={(newValue) =>
                                setSetup((prev) => ({ ...prev, lightHours: newValue[0] }))
                            }
