...
const SetupResultDisplay: React.FC<{
    ...
    sourceDetails: Omit<
        SavedSetup,
        'id' | 'createdAt' | 'name' | 'recommendation' | 'totalCost'
    >['sourceDetails']
    onSave: () => void
    onReset: () => void
    ...
    const prioritiesText = sourceDetails.priorities
    ...
    return (
        <div className="animate-fade-in">
            <h2 className="text-2xl font-bold text-primary-400">
                {t('equipmentView.configurator.resultsTitle')}
            </h2>
            ...
            <div className="mt-6 pt-4 border-t border-slate-700 flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="text-2xl font-bold">
                    ...
                    <span className="text-primary-400">
                        {totalCost.toFixed(2)} {t('common.units.currency_eur')}
                    </span>
                </div>
                <div className="flex gap-2">
                    <Button variant="secondary" onClick={onReset}>
                        {t('equipmentView.configurator.startOver')}
                    </Button>
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold font-display text-primary-400">
                {t('equipmentView.configurator.title')}
            </h2>
            ...
            {step === 1 && (
                <div className="space-y-6 animate-fade-in">
                    <FormSection
                        title={t('equipmentView.configurator.plantCount_other', { count: 0 })}
                        defaultOpen
                    >
                        <SegmentedControl
                            value={[plantCount]}
                    ...
                    <FormSection title={t('equipmentView.configurator.growSpaceTitle')} defaultOpen>
                        <p className="text-sm text-slate-400 -mt-2 mb-2 sm:col-span-2">
                            {t('equipmentView.configurator.growSpaceDescription')}
                        </p>
                        <Input
                            label={t('equipmentView.configurator.width')}
                            type="number"
                        ...
                        />
                        <Input
                            label={t('equipmentView.configurator.depth')}
                            type="number"
                    ...
                    <FormSection title={t('equipmentView.configurator.floweringTypeTitle')} defaultOpen>
                        <SegmentedControl
                            ...
                            options={[
                                ...
                                {
                                    value: 'photoperiod',
                                    label: t('equipmentView.configurator.floweringTypePhotoperiod'),
                                },
                            ]}
                        />
                    </FormSection>
            ...
            {step === 2 && (
                <div className="space-y-6 animate-fade-in">
                    ...
                    <FormSection title={t('equipmentView.configurator.step3TitleNew')} defaultOpen>
                        <p className="text-sm text-slate-400 -mt-2 mb-2 sm:col-span-2">
                            {t('equipmentView.configurator.priorityDescription')}
                        </p>
            ...
            {step === 3 && (
                <div className="space-y-6 animate-fade-in">
                    <FormSection title={t('equipmentView.configurator.step4TitleNew')} defaultOpen>
                        <p className="text-sm text-slate-400 -mt-2 mb-2 sm:col-span-2">
                            {t('equipmentView.configurator.customNotesDescription')}
                        </p>
                        <div className="sm:col-span-2">
                            <Input
                                as="textarea"
                                ...
                                placeholder={t('equipmentView.configurator.customNotesPlaceholder')}
                            />
                        </div>
                    </FormSection>
                    <div className="flex justify-between mt-8">
