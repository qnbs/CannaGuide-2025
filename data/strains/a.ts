...
export const strainsA: Strain[] = [
    ...
    createStrainObject({
        ...
        "description": "A legendary sativa-dominant landrace from the mountains near Acapulco, Mexico, renowned since the 1960s, and a prime example of a 'Mexican Sativa'. It's famous for its beautiful buds that are dense with orange hairs, giving them a golden hue. The effect is highly cerebral, energizing, and euphoric, making it a classic 'wake-and-bake' strain that reduces stress and fatigue. Its unique flavor profile is often described as burnt toffee, coffee, and sweet earth.",
        "agronomic": {
            "difficulty": "Hard",
            "yield": "Medium",
            "height": "Tall",
    ...
    createStrainObject({
        ...
        "type": StrainType.Hybrid,
        "typeDetails": "Hybrid - 80% Indica / 20% Sativa",
        "genetics": "(Kush phenotype) x Brazilian Sativa",
        "floweringType": "Photoperiod",
        "thc": 19,
        "cbd": 1,
        "thcRange": "15-23%",
        ...
        "aromas": ["Berry", "Sweet", "Floral", "Grape"],
    ...
    createStrainObject({
        ...
        "type": StrainType.Hybrid,
        "typeDetails": "Hybrid - 70% Sativa / 30% Indica",
        "genetics": "Matanuska Valley Sativa x (Afghani x Northern Lights)",
        "floweringType": "Photoperiod",
        "thc": 22,
        "cbd": 1,
        "thcRange": "18-26%",
    ...
    createStrainObject({
        ...
        "aromas": ["Vanilla", "Sweet", "Earthy", "Pungent"],
        "dominantTerpenes": ["Caryophyllene", "Limonene", "Myrcene"]
    }),
    createStrainObject({
        "id": "alien-dawg",
    ...
    createStrainObject({
        ...
        "type": StrainType.Hybrid,
        "typeDetails": "Hybrid - 50% Sativa / 50% Indica",
        "genetics": "Alien Dawg x Las Vegas Purple Kush",
        "floweringType": "Photoperiod",
        "thc": 19,
        "cbd": 1,
        "thcRange": "15-23%",
    ...
    createStrainObject({
        ...
        "aromas": ["Lemon", "Pine", "Earthy", "Sweet"],
        "dominantTerpenes": ["Myrcene", "Limonene", "Caryophyllene"]
    }),
    createStrainObject({
        "id": "alien-rock-candy",
    ...
    createStrainObject({
        ...
        "genetics": "Afghani Skunk x Jamaican Sativa",
        "floweringType": "Photoperiod",
        "thc": 18,
        "cbd": 1,
        "thcRange": "16-20%",
        ...
        "aromas": ["Earthy", "Skunk", "Sweet", "Tropical"],
        "dominantTerpenes": ["Myrcene", "Caryophyllene", "Limonene"]
    }),
    createStrainObject({
        "id": "amnesia",
        ...
        "aromas": ["Earthy", "Citrus", "Lemon", "Sweet"],
        "dominantTerpenes": ["Myrcene", "Caryophyllene", "Limonene"]
    }),
    createStrainObject({
        "id": "amnesia-haze",
        ...
        "type": StrainType.Hybrid,
        "typeDetails": "Hybrid - 80% Sativa / 20% Indica",
        "genetics": "(Afghani Hawaiian x Jamaican) x (Laotian x Cambodian)",
        "floweringType": "Photoperiod",
        "thc": 22,
        "cbd": 1,
        "thcRange": "20-24%",
    ...
    createStrainObject({
        ...
        "genetics": "Amnesia Haze x Skunk #1",
        "floweringType": "Photoperiod",
        "thc": 21,
        "cbd": 1,
        "thcRange": "19-23%",
    ...
    createStrainObject({
        ...
        "genetics": "Apple Fritter x (GMO x GSC)",
        "floweringType": "Photoperiod",
        "thc": 32.5,
        "cbd": 1,
        "thcRange": "30-35%",
        ...
        "aromas": ["Apple", "Cinnamon", "Chocolate", "Sweet"],
        "dominantTerpenes": ["Caryophyllene", "Limonene", "Myrcene"]
    }),
    createStrainObject({
        "id": "apple-cobbler",
        ...
        "aromas": ["Apple", "Fruity", "Sour", "Earthy"],
        "dominantTerpenes": ["Myrcene", "Pinene", "Caryophyllene"]
    }),
    createStrainObject({
        "id": "apple-fritter",
    ...
    createStrainObject({
        ...
        "aromas": ["Apple", "Banana", "Cherry", "Spicy"],
        "dominantTerpenes": ["Myrcene", "Limonene", "Caryophyllene"]
    }),
    createStrainObject({
        "id": "atomic-apple",
        ...
        "aromas": ["Apple", "Mint", "Earthy", "Sweet"],
        "dominantTerpenes": ["Caryophyllene", "Limonene", "Myrcene"]
    }),
    createStrainObject({
        "id": "aurora-indica",
    ...
    createStrainObject({
        ...
        "aromas": ["Earthy", "Pine", "Floral", "Citrus"],
        "dominantTerpenes": ["Pinene", "Terpinolene", "Myrcene"]
    }),
    createStrainObject({
        "id": "auto-white-widow",
        ...
        "aromas": ["Earthy", "Spicy", "Woody", "Pungent"],
        "dominantTerpenes": ["Myrcene", "Caryophyllene", "Pinene"]
    }),
    createStrainObject({
        "id": "ayahuasca-purple",
        ...
        "aromas": ["Hazelnut", "Papaya", "Sweet", "Fruity"],
        "dominantTerpenes": ["Myrcene", "Caryophyllene", "Limonene"]
    })
];
