...
import { selectSimulation, selectArchives, selectUserStrains, selectSavedItems } from '@/stores/selectors';
...
export const useStorageEstimate = () => {
    ...
    useEffect(() => {
        const calculateSizes = async () => {
            ...
            const formattedEstimates = Object.entries(newEstimates).reduce((acc, [key, value]) => {
