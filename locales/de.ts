export const de = {
  ...
  helpView: {
    ...
    sections: {
      ...
      about: {
        ...
        githubText: 'Diese Anwendung ist vollständig Open Source und der Quellcode ist auf GitHub verfügbar. Du bist herzlich eingeladen, den Code einzusehen, Fehler zu melden oder zur Entwicklung des Projekts beizutragen. Deine Mitarbeit hilft, den Grow Guide noch besser zu machen!',
  ...
  settingsView: {
    ...
    fontSizeDescription: 'Passe die globale Schriftgröße der Benutzeroberfläche an, um die Lesbarkeit zu verbessern.',
    fontSizes: {
      sm: 'Klein',
      base: 'Standard',
      lg: 'Groß',
    ...
    language: 'Sprache',
    languageDescription: 'Wähle deine bevorzugte Sprache für die gesamte Anwendungsoberfläche.',
    languages: {
      de: 'Deutsch',
      en: 'English',
    },
    presetsTitle: 'Voreinstellungen & Standards',
    presetsDescription: 'Konfiguriere Standardeinstellungen für verschiedene App-Funktionen, um deinen Arbeitsablauf zu optimieren.',
    defaultGrowSetup: 'Standard-Anbau-Setup',
    defaultGrowSetupDescription: 'Lege die Standardausrüstung und Umgebungsparameter fest, die beim Starten eines neuen Anbaus vorausgefüllt werden.',
    defaultJournalNotes: 'Standard-Journaleinträge',
    defaultJournalNotesDescription: 'Setze Standardnotizen für häufige Aktionen wie Gießen und Düngen. Lasse die Felder leer, um den Standard-Platzhalter zu verwenden.',
    defaultWateringNote: 'Standard-Gießnotiz',
    defaultFeedingNote: 'Standard-Düngungsnotiz',
    defaultExportSettings: 'Standard-Exporteinstellungen',
    defaultExportSettingsDescription: 'Wähle deine am häufigsten verwendete Quelle und dein Format für den Export von Sortendaten.',
    notificationsTitle: 'Benachrichtigungen',
    notificationsDescription: 'Verwalte, welche In-App-Benachrichtigungen du für wichtige Ereignisse erhalten möchtest.',
    notificationsEnable: 'Benachrichtigungen aktivieren',
    notificationsEnableDescription: 'Hauptschalter, um alle In-App-Benachrichtigungen zu aktivieren oder zu deaktivieren.',
    stageChange: 'Phasenwechsel',
    stageChangeDescription: 'Benachrichtigung, wenn eine Pflanze eine neue Lebensphase wie z.B. die Blüte erreicht.',
    problemDetected: 'Problemerkennung',
    problemDetectedDescription: 'Benachrichtigung, wenn bei einer Pflanze ein Problem wie z.B. Unterwässerung festgestellt wird.',
    harvestReady: 'Erntebereit',
    harvestReadyDescription: 'Benachrichtigung, wenn eine Pflanze nach Abschluss der Blütephase erntereif ist.',
    newTask: 'Neue Aufgabe erstellt',
    newTaskDescription: 'Benachrichtigung, wenn eine neue Aufgabe mit hoher Priorität (z.B. "Pflanze gießen") für eine Pflanze erstellt wird.',
    simulation: 'Simulation & Gameplay',
    simulationDescription: 'Passe Parameter an, die die Simulation des Pflanzenwachstums und ihre Herausforderungen beeinflussen.',
    simulationSpeed: 'Simulationsgeschwindigkeit',
    simulationSpeedDescription: 'Bestimmt, wie schnell die Zeit für deine Pflanzen vergeht. Eine höhere Geschwindigkeit lässt Tage schneller vergehen.',
    simulationDifficulty: 'Schwierigkeitsgrad',
    simulationDifficultyDescription: 'Beeinflusst, wie stark sich Probleme auf den Stresslevel und das Wachstum der Pflanze auswirken.',
    difficulties: {
      easy: 'Einfach',
      normal: 'Normal',
      hard: 'Schwer',
    ...
    dataManagementDescription: 'Exportiere ein vollständiges Backup all deiner Anwendungsdaten oder importiere ein früheres Backup, um deinen Fortschritt wiederherzustellen.',
    exportBackup: 'Backup exportieren',
    exportBackupDescription: 'Sichere alle deine App-Daten (Pflanzen, Favoriten, eigene Sorten, Exporthistorie und Einstellungen) in einer einzigen JSON-Datei.',
    exportButton: 'Vollständiges Backup exportieren',
    importBackup: 'Backup importieren',
    importBackupDescription: 'Stelle deine Daten aus einer zuvor exportierten Backup-Datei wieder her. Achtung: Alle aktuellen Daten werden überschrieben.',
    importButton: 'Backup importieren',
    lastBackup: 'Letztes Backup',
    noBackup: 'Es wurde noch kein Backup erstellt.',
    dangerZone: 'Gefahrenzone',
    resetUserStrainsTitle: 'Zurücksetzen "Meine Sorten"',
    resetUserStrainsDescription: 'Löscht nur die von dir manuell hinzugefügten Sorten. Alle anderen Daten bleiben vollständig erhalten.',
    resetUserStrainsButton: 'Meine Sorten löschen',
    resetExportsHistoryTitle: 'Zurücksetzen "Meine Exporte"',
    resetExportsHistoryDescription: 'Löscht nur die Historie deiner gespeicherten Exporte. Alle anderen Daten bleiben vollständig erhalten.',
    resetExportsHistoryButton: 'Exporthistorie löschen',
    fullResetTitle: 'Vollständiger App-Reset',
    fullResetDescription: 'Setzt die gesamte Anwendung auf den Werkszustand zurück. Alle deine Pflanzen, Favoriten, Exporte, eigenen Sorten und Einstellungen werden dauerhaft gelöscht.',
