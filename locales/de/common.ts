...
export const ai = {
  ...
  gemini: {
    ...
    strainTipsCombinedPrompt: "Du bist ein Meisterzüchter. Deine Aufgabe ist es, 3 prägnante, anspruchsvolle und expertenbasierte Profi-Tipps für den Anbau der unten beschriebenen Sorte zu geben. Jeder Tipp muss sehr spezifisch und umsetzbar sein und sich direkt auf die bekannten Eigenschaften der Sorte beziehen.\n\n**Sortendetails:**\n- **Name:** {name}\n- **Typ:** {type}\n- **Schwierigkeit:** {difficulty}\n- **Höhe:** {height}\n- **Blütezeit:** {flowering} Wochen\n\n**Anweisungen für das Ausgabeformat:**\nDie Antwort muss ein JSON-Objekt sein. Der Titel muss genau 'Profi-Tipps für den Anbau von {name}' lauten. Der Inhalt muss gültiges Markdown sein und genau drei Aufzählungspunkte als Tipps enthalten."
  }
};