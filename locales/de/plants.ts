export const plantsView = {
  ...
  postHarvest: {
      ...
      burpOverdue: 'Lüften überfällig!',
        targetDryingWindow: 'Ziel im Trockenraum: 18-20 °C und 55-60% RH für eine langsame, terpenschonende Trocknung.',
        targetCuringWindow: 'Ziel im Glas: 58-62% RH mit täglichem Lüften, bis sich die Reifung stabilisiert.',
        ...
        thresholds: {
          ...
          jarHumidityDryHint: 'Während der Trocknung verlangsamen Werte oberhalb der niedrigen 60er die Feuchteabgabe und erhöhen die Schimmel-Exposition.',
          jarHumidityCureHint: 'Während der Reifung liegt die sauberste Zone etwa bei 60-62% RH. Größere Abweichungen erhöhen Rehydrierungs- oder Staufeuchte-Risiko.',
          moldRisk: 'Schimmeldruck',
          moldRiskHint: 'Dieser Wert sollte niedrig bleiben. Steigende Werte zeigen, dass Luftaustausch, Feuchte oder Lüftungsrhythmus vom Ziel abweichen.',
          burpDebt: 'Lüftungsrückstand',
          burpDebtHint: 'Jeder Rückstand bedeutet, dass eingeschlossene Feuchte zu lange nicht abgelassen wurde. Mehr als ein Tag ist ein riskantes Reifungsmuster.',
          terpeneRetention: 'Terpenerhalt',
          terpeneRetentionHint: 'Schnelle Verluste deuten meist auf zu warme, zu trockene oder zu instabile Nacherntebedingungen hin.',
        },
        recommendations: {
        none: 'Aktuell ist kein Eingriff nötig. Die Nachernte verläuft stabil.',
        lowerHumidity: 'Senke die Luftfeuchtigkeit im Trockenraum leicht, um Schimmelrisiko zu drücken und das Finish zu schärfen.',
        increaseAirflow: 'Erhöhe sanfte Luftbewegung oder Luftaustausch. Die Restfeuchte entweicht aktuell zu ungleichmäßig.',
        burpNow: 'Lüfte die Gläser jetzt. In der aktuellen Reifung hat sich Feuchtedruck aufgebaut.',
        stabilizeJarRh: 'Stabilisiere die Glasfeuchte näher bei 60-62%, damit die Reifung sauberer und das Aroma gleichmäßiger bleibt.',
        holdSteady: 'Halte die Umgebung jetzt stabil. Das Profil läuft bereits auf ein sehr gutes Finish zu.',
        },
  },
      simulationDebug: {
