...
export const plantsView = {
  ...
  aiDiagnostics: {
    ...
    generalContext: 'Allgemeiner Kontext / Keine Pflanze',
    userNotes: 'Zusätzliche Notizen',
    userNotesPlaceholder: 'z.B. Untere Blätter betroffen, trat vor 2 Tagen auf...',
    savedToJournal: 'Diagnose wurde dem Journal hinzugefügt.'
  },
  gardenVitals: {
