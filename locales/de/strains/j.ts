export const strains = {
  "jack-frost": {
    ...
    "aromas": ["Süß", "Zitrus", "Kiefer", "Erdig"],
  ...
  "jack-herer": {
    ...
    "aromas": ["Kiefer", "Würzig", "Erdig", "Süß"],
    "dominantTerpenes": ["Terpinolen", "Caryophyllen", "Myrcen"],
  ...
  "jack-the-ripper": {
    ...
    "aromas": ["Zitrone", "Zitrus", "Kiefer", "Würzig"],
    "dominantTerpenes": ["Terpinolen", "Myrcen", "Pinen"],
  ...
  "jager": {
    ...
    "aromas": ["Lakritz", "Süß", "Erdig", "Würzig"],
  ...
  "jamaican-pearl": {
    ...
    "aromas": ["Süß", "Fruchtig", "Tropisch", "Würzig"],
    "dominantTerpenes": ["Myrcen", "Caryophyllen", "Limonen"],
    "yieldDetails": { "indoor": "450-550 g/m²", "outdoor": "~600 g/Pflanze" },
    "heightDetails": { "indoor": "180-250 cm", "outdoor": "bis 3 m" }
  },
  "jealousy": {
    "description": "Eine ausgewogene Hybride mit einem süßen, fruchtigen und leicht cremigen Aroma. Die Wirkung ist stark, euphorisch und entspannend.",
    "typeDetails": "Hybrid 50% / 50%",
    "genetics": "Sherbert Bx1 x Gelato #41",
    "aromas": ["Süß", "Fruchtig", "Cremig", "Erdig"],
  ...
  "jenny-kush": {
    ...
    "aromas": ["Süß", "Zitrus", "Blumig", "Erdig"],
    "dominantTerpenes": ["Myrcen", "Limonen", "Caryophyllen"],
  ...
  "jesus-og": {
    ...
    "aromas": ["Erdig", "Zitrus", "Süß", "Kiefer"],
    "dominantTerpenes": ["Terpinolen", "Myrcen", "Limonen"],
    "yieldDetails": { "indoor": "~450 g/m²", "outdoor": "~550 g/Pflanze" },
  ...
  "jet-fuel": {
    ...
    "aromas": ["Diesel", "Scharf", "Erdig", "Süß"],
    "dominantTerpenes": ["Myrcen", "Limonen", "Caryophyllen"],
    "yieldDetails": { "indoor": "~450 g/m²", "outdoor": "~550 g/Pflanze" },
  ...
  "jillybean": {
    ...
    "aromas": ["Orange", "Mango", "Süß", "Fruchtig"],
    "dominantTerpenes": ["Myrcen", "Limonen", "Caryophyllen"],
    "yieldDetails": { "indoor": "~400 g/m²", "outdoor": "~500 g/Pflanze" },
