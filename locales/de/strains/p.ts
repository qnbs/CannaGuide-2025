...
export const strains: Record<string, StrainTranslationData> = {
  ...
  "purple-elephant": {
    "description": "Eine Indica-dominante Hybride und ein Elternteil von Grape Stomper. Bekannt für ihr starkes Traubenaroma und ihre entspannende Wirkung, die Stress und Schmerzen bekämpft."
  },
  "painkiller-xl": {
  ...
  "purple-space-cookies": {
    "description": "Purple Space Cookies ist eine Sativa-dominante Hybride, die für ihr süßes Beerenaroma und ihre erhebende Wirkung bekannt ist. Konsumenten berichten von einem energetischen und euphorischen Rausch, der die Kreativität anregt und gleichzeitig eine angenehme körperliche Entspannung bietet. Das komplexe Geschmacksprofil mischt süße, erdige Noten mit einem Hauch von Kiefer und Früchten.",
    "typeDetails": "Sativa 70% / Indica 30%",
