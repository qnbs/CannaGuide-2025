...
export const strains: Record<string, StrainTranslationData> = {
  ...
  "skunk-1": {
    ...
    "genetics": "Afghani x Mexican x Colombian",
    "yieldDetails": { "indoor": "500-600 g/m²", "outdoor": "600-700 g/Pflanze" },
    "heightDetails": { "indoor": "100-150 cm", "outdoor": "120-180 cm" }
  },
  "skywalker": {
  ...
  "shishkaberry": {
    "description": "Auch bekannt als 'Kish', ist Shishkaberry eine potente indica-dominante Hybride. Sie liefert ein glückliches, glückseliges High, das mit einem zerebralen Auftrieb beginnt, bevor es in eine Ganzkörperentspannung übergeht. Ihr Aroma ist eine köstliche Mischung aus süßen Beeren und erdigen Noten.",
    "typeDetails": "Indica 80% / Sativa 20%",
