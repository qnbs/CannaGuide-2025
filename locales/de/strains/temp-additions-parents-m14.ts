...
export const strains: Record<string, StrainTranslationData> = {
  ...
  "marleys-collie": {
    "description": "Eine sativa-dominante Sorte, die von Sensi Seeds zu Ehren von Bob Marley kreiert wurde. Sie kombiniert ein süßes, tropisches Aroma mit einem erhebenden, kreativen und energetischen High. Sie ist ein Elternteil von Jamaican Pearl."
  },
  "martian-mean-green": {
