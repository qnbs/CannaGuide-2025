...
export const strains: Record<string, StrainTranslationData> = {
    "white-fire-alien-og": {
        "description": "Eine potente indica-dominante Hybride, die die starke Harzproduktion von The White mit dem außerweltlichen OG-Funk von Fire Alien Kush kombiniert. Sie bietet ein starkes, entspannendes High, das den Geist und Körper beruhigt, was sie zu einer großartigen Wahl für Stressabbau und Schlaf macht. Das Aroma ist eine scharfe Mischung aus erdigem Zitrone, saurem Zitrus und Diesel."
    },
    "wappa": {
    ...
    "white-rhino": {
        ...
        "genetics": "White Widow x Nordamerikanische Indica",
        "yieldDetails": { "indoor": "600-900 g/m²", "outdoor": "700-800 g/Pflanze" },
        "heightDetails": { "indoor": "80-120 cm", "outdoor": "100-150 cm" }
    },
    "white-runtz": {
    ...
    "white-widow": {
        ...
        "genetics": "Brasilianische Sativa Landrasse x Südindische Indica",
        "yieldDetails": { "indoor": "450-550 g/m²", "outdoor": "500-600 g/Pflanze" },
        "heightDetails": { "indoor": "100-150 cm", "outdoor": "120-180 cm" }
    },
    "whitewalker-og": {
    ...
    "wonder-woman": {
        ...
        "yieldDetails": { "indoor": "600-1000 g/m²", "outdoor": "700-800 g/Pflanze" },
        "heightDetails": { "indoor": "150-200 cm", "outdoor": ">200 cm" }
    },
    "wu-5": {
    ...
    "white-truffle": {
        "description": "Eine potente indica-dominante Sorte mit einem herzhaften, erdigen Aroma, das an Trüffel und Knoblauch erinnert. Die Wirkung ist schnell einsetzend und sorgt für einen zerebralen Rausch, der sich in ein entspannendes Körper-High legt.",
        "typeDetails": "Indica 70% / Sativa 30%",
        "genetics": "Gorilla Butter",
        "yieldDetails": { "indoor": "400-500 g/m²" },
        "heightDetails": { "indoor": "100-150 cm" }
    },
    "white-train-haze": {
        "description": "Eine potente sativa-dominante Sorte mit einem komplexen Aroma von Zitrone, Kiefer und Gewürzen. Sie liefert ein starkes, energetisches und euphorisches High, das sich hervorragend für Kreativität und Konzentration eignet.",
