...
export const en = {
    ...
    sections: {
      ...
      glossary: {
        ...
        items: {
          ...
          g5: { term: 'Landrace', def: 'A pure, original cannabis strain that has developed and adapted naturally over a long period in a specific geographical region (e.g., Afghan Kush, Durban Poison).' },
          ...
          g8: { term: 'Pistil', def: 'The small "hairs" on the calyxes, which are initially white and turn orange/brown upon ripening. They are used to catch pollen.' },
          g9: { term: 'Trichomes', def: 'The tiny, mushroom-shaped resin glands on the flowers and leaves that produce cannabinoids and terpenes. Their color (clear, milky, amber) is the best indicator for harvest time.' },
        }
      },
      about: {
        title: 'About the App',
        ...
        features: '<strong>New Features:</strong> This version includes a full translation for German and English, as well as comprehensive accessibility improvements (keyboard & screen reader support).',
        devWithAIStudioTitle: 'Developed with AI Studio',
        devWithAIStudioText: 'This app was developed with <strong>AI Studio</strong> by Google, an innovative platform that enables the creation and modification of complex web applications through natural language commands. The user interface was designed, functionalities implemented, and the Gemini AI integrated for intelligent features through iterative prompts. AI Studio significantly accelerates the development process and opens up new possibilities in app creation.',
        getTheAppHere: 'Get the app here',
        githubTitle: 'Open Source on GitHub',
        githubText: 'This application is fully open source and the source code is available on GitHub. You are welcome to view the code, report issues, or contribute to the development of the project. Your contributions help make the Grow Guide even better!',
  ...
  settingsView: {
    ...
    display: 'Display',
    fontSize: 'Font Size',
    fontSizeDescription: 'Adjust the global font size of the user interface to improve readability.',
    fontSizes: {
      sm: 'Small',
      base: 'Default',
      lg: 'Large',
    ...
    language: 'Language',
    languageDescription: 'Choose your preferred language for the entire application interface.',
    languages: {
      de: 'Deutsch',
      en: 'English',
    },
    presetsTitle: 'Presets & Defaults',
    presetsDescription: 'Configure default settings for various app features to streamline your workflow.',
    defaultGrowSetup: 'Default Grow Setup',
    defaultGrowSetupDescription: 'Set the default equipment and environmental parameters that are pre-filled when starting a new grow.',
    defaultJournalNotes: 'Default Journal Notes',
    defaultJournalNotesDescription: 'Set default notes for common actions like watering and feeding. Leave blank to use the default placeholder.',
    defaultWateringNote: 'Default Watering Note',
    defaultFeedingNote: 'Default Feeding Note',
    defaultExportSettings: 'Default Export Settings',
    defaultExportSettingsDescription: 'Choose your most-used source and format for exporting strain data.',
    notificationsTitle: 'Notifications',
    notificationsDescription: 'Manage which in-app notifications you want to receive for important events.',
    notificationsEnable: 'Enable Notifications',
    notificationsEnableDescription: 'Master switch to enable or disable all in-app notifications.',
    stageChange: 'Stage Change',
    stageChangeDescription: 'Notify when a plant reaches a new life stage, such as flowering.',
    problemDetected: 'Problem Detected',
    problemDetectedDescription: 'Notify when a problem like underwatering is detected on a plant.',
    harvestReady: 'Harvest Ready',
    harvestReadyDescription: 'Notify when a plant is ready for harvest after completing its flowering stage.',
    newTask: 'New Task Created',
    newTaskDescription: 'Notify when a new high-priority task (e.g., "Water Plant") is created for a plant.',
    simulation: 'Simulation & Gameplay',
    simulationDescription: 'Adjust parameters that affect the plant growth simulation and its challenges.',
    simulationSpeed: 'Simulation Speed',
    simulationSpeedDescription: 'Determines how fast time passes for your plants. A higher speed makes days pass more quickly.',
    simulationDifficulty: 'Difficulty Level',
    simulationDifficultyDescription: 'Affects how much problems impact the plant\'s stress level and growth.',
    difficulties: {
      easy: 'Easy',
      normal: 'Normal',
      hard: 'Hard',
    ...
    dataManagementDescription: 'Export a full backup of all your application data or import a previous backup to restore your progress.',
    exportBackup: 'Export Backup',
    exportBackupDescription: 'Save all your app data (plants, favorites, custom strains, export history, and settings) to a single JSON file.',
    exportButton: 'Export Full Backup',
    importBackup: 'Import Backup',
    importBackupDescription: 'Restore your data from a previously exported backup file. Warning: All current data will be overwritten.',
    importButton: 'Import Backup',
    lastBackup: 'Last Backup',
    noBackup: 'No backup has been created yet.',
    dangerZone: 'Danger Zone',
    resetUserStrainsTitle: 'Reset "My Strains"',
    resetUserStrainsDescription: 'Deletes only the strains you have manually added. All other data will remain intact.',
    resetUserStrainsButton: 'Delete My Strains',
    resetExportsHistoryTitle: 'Reset "My Exports"',
    resetExportsHistoryDescription: 'Deletes only the history of your saved exports. All other data will remain intact.',
    resetExportsHistoryButton: 'Delete Export History',
    fullResetTitle: 'Full App Reset',
    fullResetDescription: 'Resets the entire application to its factory state. All your plants, favorites, exports, custom strains, and settings will be permanently deleted.',
    ...
    notifications: {
      ...
      userStrainsResetConfirm: 'Are you sure you want to permanently delete all strains you added? Your plants and exports will remain.',
  ...
  problemMessages: {
    ...
    nutrientBurn: { message: 'Nutrient Burn (EC too high)', solution: 'Flush the substrate and reduce nutrient dosage.' },
    nutrientDeficiency: { message: 'Nutrient Deficiency (EC too low)', solution: 'Slightly increase nutrient dosage.' },
  ...
  tipOfTheDay: {
    ...
    tips: [
      ...
      "Ensure good air circulation with a small fan. This strengthens the stems and helps prevent mold.",
      "Mind the distance between your lamp and the plant canopy. Too close can cause light burn; too far reduces growth.",
      "During the flowering stage, humidity is critical. Try to keep it below 50% to minimize the risk of bud rot.",
      "Less is often more with nutrients. Start with half the recommended dose and observe your plant's reaction before increasing it.",
      "Cal/Mag supplements are often necessary, especially with LED lighting and in coco coir, to prevent deficiencies.",
      "LST (Low Stress Training) is a beginner-friendly method to increase yield by gently bending branches down.",
      ...
      "Night temperatures should not drop more than 10°C (18°F) below daytime temperatures to avoid stressing the plant.",
      "In late flowering, selectively removing some large fan leaves (defoliation) can improve light penetration to lower bud sites.",
      "Flush your plants with plain water for the last 1-2 weeks before harvest to improve the final taste.",
      "Proper drying and curing are just as important as the grow itself. Take your time with this process; it's worth it!",
      "Yellow sticky traps are a simple and effective way to detect an infestation of fungus gnats or other flying pests early.",
      ...
      "An EC meter is a valuable tool for accurately monitoring the nutrient concentration of your solution.",
