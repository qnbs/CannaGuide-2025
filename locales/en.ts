export const en = {
  ...
  settingsView: {
    ...
    display: 'Display',
    fontSize: 'Font Size',
    fontSizeDescription: 'Adjust the global user interface font size to enhance readability.',
    fontSizes: {
      sm: 'Small',
      base: 'Default',
      lg: 'Large',
    ...
    presetsDescription: 'Configure default settings for various app functions to streamline your workflow.',
    defaultGrowSetup: 'Default Grow Setup',
    defaultGrowSetupDescription: 'Set the default equipment and environment parameters that are pre-filled when you start a new grow.',
    defaultJournalNotes: 'Default Journal Notes',
    defaultJournalNotesDescription: 'Set default notes for common actions like watering and feeding. Leave blank to use the standard placeholder.',
    ...
    defaultExportSettingsDescription: 'Choose your most frequently used source and format for strain data exports.',
    notificationsTitle: 'Notifications',
    notificationsDescription: 'Manage which in-app toast notifications you want to receive for important events.',
    notificationsEnable: 'Enable Notifications',
    notificationsEnableDescription: 'Master switch to enable or disable all in-app toast notifications.',
    ...
    problemDetectedDescription: 'Notify when a problem, such as underwatering, is detected with a plant.',
    harvestReady: 'Harvest Ready',
    harvestReadyDescription: 'Notify when a plant is ready for harvest after completing its flowering cycle.',
    newTask: 'New Task Generated',
    ...
    simulationDescription: 'Adjust parameters that influence the plant growth simulation and its challenges.',
    simulationSpeed: 'Simulation Speed',
    simulationSpeedDescription: 'Determines how fast time passes for your plants. A higher speed makes days go by faster.',
    ...
    exportBackupDescription: 'Back up all your app data (plants, favorites, custom strains, export history, and settings) to a single JSON file.',
    ...
    resetUserStrainsDescription: 'Deletes only the strains you have manually added. All other data will remain untouched.',
    resetUserStrainsButton: 'Delete My Strains',
    resetExportsHistoryTitle: 'Reset "My Exports"',
    resetExportsHistoryDescription: 'Deletes only your history of saved exports. All other data will remain untouched.',
