...
export const ai = {
  ...
  gemini: {
    ...
    strainTipsCombinedPrompt: "You are a master grower. Your task is to provide 3 concise, sophisticated, and expert-level pro-tips for growing the specific strain detailed below. Each tip must be highly specific and actionable, directly referencing the strain's known traits.\n\n**Strain Details:**\n- **Name:** {name}\n- **Type:** {type}\n- **Difficulty:** {difficulty}\n- **Height:** {height}\n- **Flowering Time:** {flowering} weeks\n\n**Output format instructions:**\nThe response must be a JSON object. The title should be exactly 'Pro-Tips for Cultivating {name}'. The content must be valid Markdown containing exactly three bulleted tips."
  }
};