export const helpView = {
  ...
  sections: {
    ...
    about: {
      ...
      description: 'Cannabis Grow Guide with Gemini - Your AI-powered digital companion for the entire cannabis cultivation cycle.',
      ...
      githubText: 'This application is fully open source and the code is available on GitHub. You are welcome to view the source code, report issues, or contribute to the project\'s development. Your collaboration helps make CannaGuide 2025 even better!',
