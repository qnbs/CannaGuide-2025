export const plantsView = {
  ...
  postHarvest: {
      ...
      burpOverdue: 'Burping Overdue!',
        targetDryingWindow: 'Target room window: 18-20 °C and 55-60% RH for a slow, terpene-safe dry.',
        targetCuringWindow: 'Target jar window: 58-62% RH with daily burping until the cure stabilizes.',
        ...
        thresholds: {
          ...
          jarHumidityDryHint: 'During drying, values drifting above the low 60s slow moisture release and can widen mold exposure.',
          jarHumidityCureHint: 'During curing, the cleanest zone is roughly 60-62% RH. Wider drift raises rehydration or stale-moisture risk.',
          moldRisk: 'Mold Pressure',
          moldRiskHint: 'This should stay low. Rising values indicate that airflow, humidity or burping cadence is off target.',
          burpDebt: 'Burp Debt',
          burpDebtHint: 'Any debt means trapped moisture has gone unvented for too long. More than one day is a high-risk cure pattern.',
          terpeneRetention: 'Terpene Retention',
          terpeneRetentionHint: 'Fast losses usually mean the room is too hot, too dry or fluctuating too hard between steps.',
        },
        recommendations: {
        none: 'No intervention needed right now. The current post-harvest trajectory is stable.',
        lowerHumidity: 'Lower the drying-room humidity slightly to reduce mold pressure and tighten the finish.',
        increaseAirflow: 'Increase gentle airflow or vent exchanges. Moisture is leaving the flowers too unevenly.',
        burpNow: 'Burp the jars now. The current cure has built up stale moisture pressure.',
        stabilizeJarRh: 'Stabilize jar humidity closer to 60-62% for a cleaner cure and more consistent aroma retention.',
        holdSteady: 'Hold the current environment steady. The profile is already converging toward a premium finish.',
        },
  },
      simulationDebug: {
  ...
  growReminderPanel: {
    ...
    batchDescription: 'Each plant batch gets a local trigger link that can be shared or scanned.',
