export const settingsView = {
  ...
  offlineAi: {
    ...
    description: 'Preload the local text and vision models while you are online so diagnoses still work when the network is unavailable.',
    ...
    forceWasmHint: 'Override WebGPU auto-detection and always use the WASM backend. Useful for debugging.',
  ...
  tts: {
    ...
    voiceControl: {
      ...
      hotwordEnabledDesc: 'Keeps the microphone ready for hands-free wake words when supported by the browser.',
  ...
  plants: {
    ...
    archivedHiddenDesc: 'This slot contains a finished grow that is currently hidden for a cleaner live dashboard.',
    ...
    simulationProfileDesc: 'Applies a documented response curve set for environment stress, nutrient volatility, pest pressure, and post-harvest precision while keeping the timeline strictly real-time.',
    simulationProfiles: {
      beginner: 'Beginner',
    ...
    pestPressureDesc: 'Feeds a non-linear pest pressure curve. Low values stay forgiving; high values escalate outbreak probability much faster.',
    ...
    environmentalStabilityDesc: 'Drives a deterministic instability curve for daily temperature and humidity drift. Lower values amplify swings sharply instead of linearly.',
    ...
    altitudeMDesc: 'Applies barometric VPD correction based on the elevation of your grow room above sea level.',
  },
  notifications: {
    title: 'Notifications',
  ...
  data: {
    ...
    localOnlyDesc: 'All your data lives on this device. No account needed — ever. Optionally enable One-Tap Cloud Sync below to back up via anonymous GitHub Gist.',
    sync: {
        title: 'One-Tap Cloud Sync',
        description: 'Back up & restore your entire app state via anonymous GitHub Gist. No account or sign-up required.',
    ...
    runCleanupDesc: 'Automatically archives old grow logs and removes older saved photos to free up space.',
    cleanupRunning: 'Cleaning up storage...',
    cleanupSuccess: 'Storage cleanup complete. Removed {{count}} old photos and archived older logs.',
