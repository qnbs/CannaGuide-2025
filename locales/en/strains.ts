export const strainsView = {
  ...
  breedingLab: {
    title: 'Breeding Lab',
    description: 'Select two parent strains to simulate Punnett Square genetics and predict F1 offspring traits.',
  ...
  addStrainModal: {
    ...
    description: 'Capture the genetic profile, growth behavior and sensory notes of a custom strain in one consistent workspace.',
  ...
  exportsManager: {
    ...
    noExports: {
      title: 'No Exports',
      subtitle: 'You haven\'t exported any data yet. Use the export function in the toolbar to get started.',
    },
  },
  tips: {
  ...
  genealogyView: {
      ...
      stateCorrupted: 'The saved state was corrupted (old version or interrupted loading). The tree will be recalculated when next opened.',
