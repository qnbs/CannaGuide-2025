export const strains: Record<string, any> = {
  "1024": {
    ...
    "genetics": "Secret proprietary cross",
    "aromas": ["Sweet", "Fruity", "Spicy", "Incense"],
    "dominantTerpenes": ["Myrcene", "Pinene", "Caryophyllene"],
    "yieldDetails": { "indoor": "500-600 g/m²", "outdoor": "~700 g/plant" },
    "heightDetails": { "indoor": "150-220 cm", "outdoor": "up to 2.5 m" }
  },
  "24k-gold": {
    "description": "Also known as Kosher Tangie. An indica-dominant hybrid with a sweet citrus and tangerine aroma. The effect is relaxing and happy, with an uplifting mental buzz.",
  ...
  "9-pound-hammer": {
    "description": "A potent indica-dominant strain with a sweet, fruity aroma of grape and lime. The effect is strong, fast-acting, and sedating.",
    "typeDetails": "Indica 80% / Sativa 20%",
