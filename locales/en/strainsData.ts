...
export const strainsData = {
  "acdc": {
    "description": "A famous CBD-dominant strain, bred for therapeutic purposes without strong psychoactive effects. The name stands for 'Alternative Cannabinoid Dietary Cannabis'. It provides a relaxing and anxiety-relieving effect while keeping the mind clear. Ideal for pain and anxiety.",
  ...
  "dance-world": {
    "description": "A CBD-rich strain from Royal Queen Seeds with a near-perfect 1:1 ratio of THC to CBD. The effect is uplifting, creative, and functional, without strong psychoactive effects. Ideal for therapeutic use during the day. The aroma is a complex mix of spicy, earthy, and fruity notes.",
    "typeDetails": "Sativa 75% / Indica 25%",
  ...
  "darth-vader-og": {
    "description": "A potent Indica strain with deeply relaxing, almost sedating effects. Ideal for relieving pain and insomnia. The aroma is earthy and sweet with notes of grape and pine.",
    "typeDetails": "Indica 100%",
  ...
  "deadhead-og": {
    "description": "A potent, sativa-dominant hybrid with a complex, pungent aroma of pine, diesel, and earth. The effect is strongly cerebral, euphoric, and energizing, ideal for experienced consumers seeking a powerful head high.",
    "typeDetails": "Sativa 60% / Indica 40%",
  ...
  "death-bubba": {
    "description": "An offspring of the popular Bubba Kush. This potent indica is known for its strong sedating effects that can lead to a deep, almost comatose sleep. Ideal for chronic pain and insomnia. The aroma is earthy, skunky, and sweet.",
    "typeDetails": "Indica 70% / Sativa 30%",
    "genetics": "Bubba Kush",
    "aromas": [
      "Earthy",
  ...
  "death-star": {
    "description": "A potent indica-dominant hybrid that provides a balanced mix of cerebral euphoria and deep body relaxation. The aroma is a pungent blend of skunk, diesel, and sweet earth. The effects are creeping and can lead to heavy sedation.",
    "typeDetails": "Indica 75% / Sativa 25%",
  ...
  "diablo-og": {
    "description": "A sativa-dominant hybrid with a sweet, spicy, and citrusy aroma. The effect is uplifting and energizing, promoting creativity and sociability while providing a gentle physical relaxation. Ideal for daytime use.",
    "typeDetails": "Sativa 60% / Indica 40%",
  ...
  "diamond-og": {
    "description": "An Indica strain known for its potent, long-lasting, and relaxing effects. It has a classic OG aroma with notes of citrus, diesel, and pine. The effect starts with a cerebral rush that quickly transitions into deep physical tranquility.",
    "typeDetails": "Indica 100%",
  ...
  "divine-gelato": {
    "description": "An indica-dominant hybrid that combines the best of the Gelato line with OG Kush. The aroma is a delicious mix of fruity, creamy, and gassy notes. The effect is powerfully relaxing and euphoric, ideal for unwinding in the evening.",
    "typeDetails": "Indica 60% / Sativa 40%",
  ...
  "do-si-dos": {
    "description": "A potent indica-dominant hybrid with a sweet, earthy, and floral aroma. The effect is powerful, starting with a warm body sensation that spreads throughout, leading to a deeply relaxed, almost meditative state. Ideal for evening use.",
    "typeDetails": "Indica 70% / Sativa 30%",
    "genetics": "OGKB (a GSC phenotype) x Face Off OG",
    "aromas": [
      "Sweet",
      "Earthy",
      "Floral",
  ...
  "do-si-woah": {
    "description": "An extremely potent indica-dominant strain known for its strong, sedating effects. It has a complex aroma of earth, gas, and sweet pastry. The effect is heavy and physical, ideal for relieving severe pain and insomnia.",
    "typeDetails": "Indica 80% / Sativa 20%",
  ...
  "dogwalker-og": {
    "description": "A balanced hybrid with a unique, pungent aroma of 'wet dog', skunk, and earth. The effect is strongly cerebral and focused while relaxing the body, making it surprisingly functional for experienced users.",
    "typeDetails": "Hybrid 50% / 50%",
  ...
  "donkey-butter": {
    "description": "A potent indica-dominant strain with an extremely pungent aroma of diesel and earthy skunk. The effect is deeply sedating and relaxing, often leading to couch-lock and is best for evening use for pain and insomnia.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "donny-burger": {
    "description": "A potent indica-dominant hybrid with a unique, savory aroma of cheese, onion, and a hint of lemon. The effect is initially uplifting and euphoric, then transitions into a deeply relaxing and calming body effect.",
    "typeDetails": "Indica 60% / Sativa 40%",
  ...
  "dosi-cake": {
    "description": "An indica-dominant hybrid that combines the sweet, earthy flavor of Do-Si-Dos with the creamy sweetness of Wedding Cake. The effect is deeply relaxing and calming, ideal for stress relief and pain management in the evening.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "double-dream": {
    "description": "A sativa-dominant hybrid known for its dreamy, gentle, and functional effects. It provides pain relief and relaxation without heavy sedation, making it a good choice for daytime use. The aroma is sweet and floral.",
    "typeDetails": "Sativa 70% / Indica 30%",
  ...
  "dr-grinspoon": {
    "description": "A pure sativa heirloom strain named after cannabis researcher Dr. Lester Grinspoon. It has a unique, beaded bud structure. The effect is purely cerebral, long-lasting, energetic, and promotes focus. A connoisseur's strain.",
    "typeDetails": "Sativa 100%",
    "genetics": "Unknown Heirloom Sativa",
    "aromas": [
      "Lemon",
      "Pine",
      "Spicy",
  ...
  "dream-star": {
    "description": "A balanced hybrid with a sweet berry and skunk aroma. It provides a relaxing yet uplifting effect that is ideal for relieving stress while remaining mentally clear and functional. Good for afternoon or evening use.",
    "typeDetails": "Hybrid 50% / 50%",
  ...
  "ducksfoot": {
    "description": "A unique sativa named for its unusual webbed leaves that make it inconspicuous. The effect is uplifting and cerebral but not overly potent. The aroma is an unusual mix of pepper and incense.",
    "typeDetails": "Sativa 100%",
    "genetics": "Australian Sativa Landrace",
    "aromas": [
      "Pepper",
      "Incense",
      "Earthy",
  ...
  "durban-poison": {
    "description": "A famous pure sativa landrace from South Africa. It's known for its extremely energizing, uplifting, and focus-enhancing effects, making it one of the most popular daytime strains. The aroma is sweet and spicy with notes of anise.",
    "typeDetails": "Sativa 100%",
  ...
  "early-maroc": {
    "description": "A very fast-flowering sativa specifically bred for outdoor growing in cooler climates. It offers a clear, uplifting effect and a sweet, earthy aroma. Ideal for growers aiming for an early harvest.",
    "typeDetails": "Sativa 100%",
  ...
  "early-pearl": {
    "description": "A classic outdoor sativa from Sensi Seeds, known for its resistance to mold and cool climates. It offers an uplifting, clear head high with a touch of body relaxation. The aroma is sweet and skunky.",
    "typeDetails": "Sativa 75% / Indica 25%",
  ...
  "early-skunk": {
    "description": "A robust and reliable strain that combines the fast flowering and resilience of Early Pearl with the potency and yield of Skunk #1. Ideal for outdoor growers in shorter summers. The effect is relaxing and happy.",
  ...
  "ed-rosenthal-super-bud": {
    "description": "Named after the legendary cannabis cultivation author. This hybrid is known for its extremely dense, resinous buds and high yield. The effect is a balanced mix of cerebral euphoria and relaxing body effects.",
    "typeDetails": "Hybrid 50% / 50%",
    "genetics": "Unknown Afghani/Kush x (Haze x Sativa)",
    "aromas": [
      "Sweet",
      "Fruity",
      "Pineapple",
  ...
  "el-chapo-og": {
    "description": "A potent indica-dominant strain known for its strong, sedating effects. It has a pungent aroma of pine, diesel, and lemon. The effect is heavily physical and ideal for relieving pain and insomnia.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "electric-lemon-g": {
    "description": "An energizing sativa-dominant strain with an intense, sharp lemon aroma. The effect is strongly cerebral, creative, and uplifting, making it an excellent choice for daytime use and social activities.",
    "typeDetails": "Sativa 80% / Indica 20%",
  ...
  "eleven-roses": {
    "description": "A pure Indica from Delicious Seeds, known for its fast flowering time and impressive resin production. The effect is extremely strong, narcotic, and sedating. The aroma is a complex mix of sweet fruits and damp earth.",
    "typeDetails": "Indica 100%",
  ...
  "elmers-glue": {
    "description": "An extremely sticky and potent hybrid, named after the famous adhesive. It offers a strong, euphoric head high that transitions into a heavy, relaxing body effect. The aroma is pungent, with notes of pine, diesel, and chocolate.",
    "typeDetails": "Hybrid 50% / 50%",
  ...
  "emergen-c": {
    "description": "A sativa-dominant strain with an intense, sweet orange and citrus aroma. The effect is uplifting, energetic, and focus-enhancing, making it a perfect choice for the morning or a creative boost in the afternoon.",
    "typeDetails": "Sativa 70% / Indica 30%",
  ...
  "emperor-cookies": {
    "description": "A potent indica-dominant strain known for its extremely frosty buds and strong, relaxing effects. It has a sweet, earthy cookie aroma. The effect is heavily physical and ideal for relieving pain and stress.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "ewok": {
    "description": "An indica-dominant strain named after the Star Wars characters. It produces dense, resinous buds with a sweet, fruity, and earthy aroma. The effect is deeply relaxing and calming, ideal for evening use.",
    "typeDetails": "Indica 80% / Sativa 20%",
  ...
  "exodus-cheese": {
    "description": "The original clone that became famous in the UK in the 90s. Known for its extremely pungent, unique cheese aroma. The effect is strong, euphoric, and social, with a pleasant body relaxation. A social strain.",
  ...
  "face-off-og": {
    "description": "An extremely potent Indica whose name comes from the intense effect that feels like it's taking your 'face off'. It provides a heavily sedating and relaxing effect, ideal for medical users. The aroma is earthy and piney.",
    "typeDetails": "Indica 70% / Sativa 30%",
    "genetics": "OG Kush phenotype",
    "aromas": [
      "Earthy",
  ...
  "fat-banana": {
    "description": "A fast-flowering, indica-dominant strain from Royal Queen Seeds with a sweet, intense banana aroma. The effect is strong, physically relaxing, and can lead to a heavy couch-lock at higher doses. Ideal for the evening.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "fire-og": {
    "description": "Considered one of the most potent OG Kush hybrids. The name comes from the red hairs that cover the buds. The effect is strong, long-lasting, and starts with an uplifting, euphoric feeling that transitions into a strong indica relaxation.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "forbidden-fruit": {
    "description": "An indica-dominant strain with an incredibly enticing aroma of tropical fruits, cherries, and citrus. The effect is deeply relaxing and calming for both body and mind, without being completely sedating. Ideal for the evening.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "freakshow": {
    "description": "A unique sativa strain known for its unusual fern-like leaf structure that makes it inconspicuous. The effect is uplifting, cerebral, and creative. The aroma is a complex mix of pine, spice, and diesel.",
    "typeDetails": "Sativa 90% / Indica 10%",
    "genetics": "Unknown Sativa Mutation",
    "aromas": [
      "Pine",
      "Spicy",
      "Diesel",
  ...
  "french-toast": {
    "description": "An indica-dominant strain with a sweet, buttery, and syrupy aroma. The effect is relaxing and calming, ideal for a cozy morning or evening. It helps to relieve stress and lift the mood.",
    "typeDetails": "Indica 60% / Sativa 40%",
  ...
  "frisian-dew": {
    "description": "An award-winning outdoor strain from Dutch Passion, known for its high mold resistance and beautiful purple colors. The effect is balanced, with an uplifting sativa high and a gentle indica relaxation. Ideal for cooler climates.",
    "typeDetails": "Hybrid 50% / 50%",
  ...
  "frisian-duck": {
    "description": "Another 'stealth' strain that combines the unique duck's foot leaf shape with the resilience of Frisian Dew. It's very inconspicuous and ideal for guerrilla growing. The effect is balanced and the aroma is spicy and piney.",
  ...
  "frosted-guava": {
    "description": "A potent, indica-dominant hybrid with a sweet, tropical, and fruity flavor profile. The effect is strongly relaxing and euphoric, ideal for stress relief and promoting creativity before a deep relaxation sets in.",
    "typeDetails": "Indica 70% / Sativa 30%",
  ...
  "fruity-pebbles-og": {
    "description": "A limited hybrid known for its extremely sweet and fruity taste, reminiscent of the breakfast cereal of the same name. The effect is strong, euphoric, and relaxing, often making one giggly and happy. Ideal for the evening.",
  ...
  "future": {
    "description": "An extremely potent strain from Anesia Seeds, known for its exceptionally high THC content. The effect is intense, psychedelic, and long-lasting, with a strong cerebral high and deep body relaxation. For experienced consumers only.",
    "typeDetails": "Hybrid 50% / 50%",
