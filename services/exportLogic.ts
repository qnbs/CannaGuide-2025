...
import { Strain, SavedSetup, RecommendationCategory, ExportFormat, ArchivedMentorResponse, SavedStrainTip, ArchivedAdvisorResponse, RecommendationItem, Recommendation } from '@/types';
...
const drawPdfLayout = (doc: jsPDF, title: string, t: (key: string, options?: any) => string) => {
...
// --- Export Logic Implementations ---

export const exportStrainsLogic = (strains: Strain[], format: ExportFormat, filename: string, t: (key: string, options?: any) => string) => {
...
export const exportSetupLogic = (setup: SavedSetup, format: ExportFormat, t: (key: string, options?: any) => string) => {
                ...
                didDrawPage: (data: any) => {
                    ...
                    if (data.pageNumber === (doc as any).internal.pages.length - 1) {
                         if (setup.recommendation.proTip) {
                            ...
                            doc.setFontSize(10);
                            doc.setFont('helvetica', 'normal');
                            const proTipLines = doc.splitTextToSize(setup.recommendation.proTip, doc.internal.pageSize.width - 30);
...
export const exportSetupsLogic = (setups: SavedSetup[], format: ExportFormat, filename: string, t: (key: string, options?: any) => string) => {
...
export const exportStrainTipsLogic = (tips: SavedStrainTip[], format: ExportFormat, filename: string, t: (key: string, options?: any) => string) => {
...
export const exportMentorArchiveLogic = (responses: ArchivedMentorResponse[], format: ExportFormat, filename: string, t: (key: string, options?: any) => string) => {
...
export const exportAdvisorArchiveLogic = (responses: (ArchivedAdvisorResponse & {plantName: string})[], format: ExportFormat, filename: string, t: (key: string, options?: any) => string) => {
    exportDataLogic(responses, format, filename, {
