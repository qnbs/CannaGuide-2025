...
class GeminiService {
  ...
  async getEquipmentRecommendation(
    prompt: string,
    lang: Language
...
- Medium Vitals: pH ${plant.medium.ph.toFixed(
      2
    )}, EC ${plant.medium.ec.toFixed(2)}
        ...
        config: {
          ...
          responseSchema: {
            ...
            properties: {
              title: {
                type: Type.STRING,
                description: t('ai.schemas.diagnostics.title'),
              },
              confidence: {
                type: Type.NUMBER,
                description: t('ai.schemas.diagnostics.confidence'),
              },
              diagnosis: {
                type: Type.STRING,
                description: t('ai.schemas.diagnostics.diagnosis'),
              },
              immediateActions: {
                type: Type.STRING,
                description: t('ai.schemas.diagnostics.immediateActions'),
              },
              longTermSolution: {
                type: Type.STRING,
                description: t('ai.schemas.diagnostics.longTermSolution'),
              },
              prevention: {
                type: Type.STRING,
                description: t('ai.schemas.diagnostics.prevention'),
              },
            },
            required: [
              'title',
