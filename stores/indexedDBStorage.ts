/** Generic async key-value storage interface used for Redux state persistence. */
...
/**
 * IndexedDB-backed state storage for Redux persistence.
 * Uses CannaGuideStateDB with promise-locked connection management.
 */
